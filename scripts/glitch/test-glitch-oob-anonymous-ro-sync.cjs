...
const runnerPath = path.join(root, "scripts/glitch/run-glitch-local-game-stack.sh");
...
ok("production deploy guardrails include OOB anonymous RO sync test", deploy.includes("test-glitch-oob-anonymous-ro-sync.cjs"));
