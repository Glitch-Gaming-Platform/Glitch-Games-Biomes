...
const { createHarness, vendorSource, economySource, inventorySource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere economy balance smoke current");
