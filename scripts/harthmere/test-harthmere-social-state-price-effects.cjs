...
const { createHarness, npcBehaviorSource, inventorySource, economySource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere social-state price effects tests current");
