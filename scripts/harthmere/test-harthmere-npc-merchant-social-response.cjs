...
const { createHarness, npcBehaviorSource, challengeSource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere NPC merchant social response tests current");
