...
check("dungeon console teleport helper exists", /HARTHMERE_DUNGEON_CONSOLE_TELEPORT_HELPER/.test(src) && /teleportToDungeonTestTarget/.test(src), "Missing teleport helper marker/function");
