...
const report = makeReporter("Harthmere solid landmark fixture collision tests current", root);
...
report.check(
  ...
  registrySrc.includes("HARTHMERE_SOLID_LANDMARK_FIXTURE_COLLISION_VERSION") &&
    registrySrc.includes("HARTHMERE_SOLID_LANDMARK_FIXTURE_PLAYER_BLOCKER_FAMILIES") &&
...
report.check(
  ...
  assetsSrc.includes("HARTHMERE_SOLID_LANDMARK_FIXTURE_COLLISION_VERSION") &&
...
report.check(
  ...
  playerSrc.includes("HARTHMERE_SOLID_LANDMARK_FIXTURE_PLAYER_COLLISION") &&
