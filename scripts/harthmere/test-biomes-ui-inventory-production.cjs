...
const files = {
  ...
  building: path.join(root, 'src/shared/harthmere/building_system.ts'),
};
...
console.log('== BiomesUI production inventory current ==');
...
ok(guildsTab.includes('BUILDING_SYSTEM_BLUEPRINTS'), 'Guild tab reads building catalogue');
