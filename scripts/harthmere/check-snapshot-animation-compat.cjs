...
ok(src.includes("HARTHMERE_FULL_BODY_ANIMATION_RUNTIME_VERSION"), "Glitch full-body animation runtime remains present");
ok(src.includes("HARTHMERE_BODY_WEAPON_ALIGNED_CLIPS_VERSION"), "Glitch aligned weapon animation clips remain present");
