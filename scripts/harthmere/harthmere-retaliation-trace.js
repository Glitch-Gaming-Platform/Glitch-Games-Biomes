 ...
 */
(function installHarthmereRetaliationTrace() {
  "use strict";

  const VERSION = "harthmere-retaliation-trace";
  const STATE_KEY = "biomes.localDev.harthmere.combatState";
