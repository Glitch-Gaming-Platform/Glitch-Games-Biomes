...
console.log('== Harthmere Emoji Mart current migration tests current ==');
...
check('ChatHUD no longer imports emoji-mart current types/index directly', !/from "emoji-mart"/.test(chat));
