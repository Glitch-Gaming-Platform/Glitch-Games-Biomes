...
echo 'Step 1/6: validate v124 test files'
node scripts/harthmere/validate-harthmere-install-player-ingame-e2e-v124.cjs "$REPO"
...
bash scripts/harthmere/test-harthmere-install-player-ingame-e2e-v124.sh "$REPO"
