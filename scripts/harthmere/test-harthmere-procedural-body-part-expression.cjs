...
const expression = bodyOf(runtime, "function addHarthmereProceduralBodyExpression(");
...
check("procedural townsperson calls body expression helper",
  createTown.includes("addHarthmereProceduralBodyExpression(root, body, palette, outfitTint)"));
check("body expression creates neck part", expression.includes('"townsperson-neck"'));
check("body expression creates shoulder line", expression.includes('"townsperson-shoulder-line"'));
check("body expression creates waist line", expression.includes('"townsperson-waist-line"'));
check("body expression neck derives height from available torso metrics",
  expression.includes("expressionHeadHeight") && expression.includes("body.torsoHeight"));
...
check("body expression exposes runtime diagnostics", expression.includes("harthmereProceduralBodyExpression"));
