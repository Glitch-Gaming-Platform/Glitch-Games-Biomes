#!/usr/bin/env node
// SNAPSHOT_CANONICAL_CHALLENGE_EXTRACTOR
...
const outPath = process.argv[3] || path.join(root, 'tmp', 'snapshot-challenge-extraction.json');
...
const report = {
  version: 'snapshot-canonical-challenge-extractor',
