...
} = require("../../src/shared/harthmere/business_employee_ai");
...
const htmlPath = path.join(outDir, "business-employee-ai-audit.html");
fs.writeFileSync(htmlPath, html, "utf8");

const summaryPath = path.join(outDir, "business-employee-ai-audit.json");
