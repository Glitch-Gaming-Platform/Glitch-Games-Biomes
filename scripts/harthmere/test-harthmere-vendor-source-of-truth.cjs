...
const { createHarness, assertUnifiedVendorCatalog, catalogOffsets, vendorClientSource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere vendor source of truth current");
...
const cat = vendorClientSource(h);
