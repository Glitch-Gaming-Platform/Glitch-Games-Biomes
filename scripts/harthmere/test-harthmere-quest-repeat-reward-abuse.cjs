...
const { createHarness, questEconomySource, inventorySource, challengeSource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere quest repeat reward abuse tests current");
