#!/usr/bin/env node
"use strict";
/* HARTHMERE_DUNGEON_TEST_ACCESS_PRINT */
...
console.log("");
console.log("  node scripts/harthmere/find-harthmere-live-runtime-url.cjs /Users/devindixon/Development/biomes-game");
...
console.log("  node scripts/harthmere/test-harthmere-live-browser-regression-suite.cjs \\");
