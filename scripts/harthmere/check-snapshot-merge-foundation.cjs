...
const extraTownOffsetPatchInstalled = shim.includes("HARTHMERE_EXTRA_TOWN_OFFSET");
...
ok(playerAnimations.includes("HARTHMERE_BODY_WEAPON_ALIGNED_CLIPS_VERSION"), "Glitch/Harthmere animation work remains present");
