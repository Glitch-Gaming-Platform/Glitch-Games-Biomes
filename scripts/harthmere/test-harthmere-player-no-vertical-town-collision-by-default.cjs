#!/usr/bin/env node
"use strict";
/* HARTHMERE_PLAYER_NO_VERTICAL_TOWN_COLLISION_BY_DEFAULT */
const fs = require("fs");
...
console.log("== Harthmere player no vertical town collision by default tests current ==");
...
if (/HARTHMERE_DISABLE_VERTICAL_TOWN_COLLISION_BY_DEFAULT/.test(text)) {
...
const callIndex = text.indexOf("intersectLocalDevHarthmereTownCollision([boxMin, boxMax], fn)");
if (callIndex < 0) {
