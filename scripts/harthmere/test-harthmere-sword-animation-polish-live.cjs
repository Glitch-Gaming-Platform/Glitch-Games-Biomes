...
const report = makeReporter("Harthmere live sword animation polish screenshot tests current", root);
...
const outDir = process.env.HARTHMERE_SWORD_SCREENSHOT_DIR || path.join(root, "scripts/harthmere/.artifacts/sword-visual-regression");
