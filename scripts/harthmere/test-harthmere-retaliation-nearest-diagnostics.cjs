...
ok("nearest diagnostics version marker exists", combat.includes("HARTHMERE_RETALIATION_NEAREST_DIAGNOSTICS"));
...
if (deploy) {
  ok("deploy guardrails include nearest diagnostics test", deploy.includes("test-harthmere-retaliation-nearest-diagnostics.cjs"));
}
