...
console.log("== Building System BiomesUI UX current ==");
...
const catalog = read("src/shared/harthmere/building_system.ts");
...
check(landTab.includes("BUILDING_SYSTEM_PLOTS"), "Building UI reads real shared Grove plot catalogue");
check(landTab.includes("BUILDING_SYSTEM_BLUEPRINTS"), "Building UI reads real shared blueprint catalogue");
check(landTab.includes("BUILDING_SYSTEM_GROVE_STEWARD_NPC"), "Building UI uses the real Grove land steward NPC");
...
check(adapters.includes("BUILDING_SYSTEM_PLOTS") && adapters.includes("BUILDING_SYSTEM_BLUEPRINTS"), "live adapter provides real Building System catalog data");
...
transpile("src/shared/harthmere/building_system.ts");
