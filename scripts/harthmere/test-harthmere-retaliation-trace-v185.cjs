...
const tracePath = path.join(root, 'scripts/harthmere/harthmere-retaliation-trace-v185.js');
...
assertContains(combat, 'biomes.localDev.harthmere.combatState.v1', 'combat state localStorage key');
...
console.log('PASS harthmere-retaliation-trace-v185 static checks');
console.log(`Root: ${root}`);
console.log('Browser usage:');
console.log('  pbcopy < scripts/harthmere/harthmere-retaliation-trace-v185.js');
