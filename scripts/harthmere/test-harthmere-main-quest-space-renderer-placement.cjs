...
check("renderer imports main quest spaces", assets.includes("main_quest_spaces"));
check("renderer has current placement start marker", assets.includes("HARTHMERE_MAIN_QUEST_SPACES_RUNTIME_PLACEMENTS_START"));
check("renderer has current placement end marker", assets.includes("HARTHMERE_MAIN_QUEST_SPACES_RUNTIME_PLACEMENTS_END"));
...
console.log("RESULT: PASS main quest space renderer placement current");
