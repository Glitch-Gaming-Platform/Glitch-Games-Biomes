...
check("preview uses deterministic SVG full-body renderer", wake.includes('data-harthmere-builder-preview-svg="current"'));
check("preview exposes a release-readable version marker", wake.includes('current-svg-full-body-readable'));
