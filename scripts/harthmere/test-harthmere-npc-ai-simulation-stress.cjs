#!/usr/bin/env node
const { createHarness, planGridPath, score, transition, emptyMemory, updateMemory } = require("./harthmere-npc-ai-test-lib.cjs");
const h = createHarness("Harthmere NPC AI simulation stress tests current"); const kinds=["merchant","guard","civilian","peasant","thief","priest","noble","creature"]; let decisions=0;
