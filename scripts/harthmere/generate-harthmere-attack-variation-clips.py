#!/usr/bin/env python3
"""Duplicate the current aligned GLTF animation clips into named 24-frame attack variation clips.
...
for gltf in sorted(variant_dir.glob("*.gltf")):
    ...
    for base_name, names in VARIANTS.items():
        ...
        for i, name in enumerate(names, start=1):
            ...
            extras.update({
                "harthmereAttackVariationVersion": "harthmere-attack-variation-sequencing",
