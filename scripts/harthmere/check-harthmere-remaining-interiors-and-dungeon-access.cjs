#!/usr/bin/env node
"use strict";
/* HARTHMERE_REMAINING_INTERIORS_AND_DUNGEON_ACCESS_TEST */
const fs = require("fs");
...
console.log("== Harthmere remaining interiors and dungeon access tests current ==");
...
const marker = "// HARTHMERE_REMAINING_INTERIORS_AND_DUNGEON_ACCESS";
...
check("remaining interiors/dungeon access marker exists", markerIndex >= 0, "Missing HARTHMERE_REMAINING_INTERIORS_AND_DUNGEON_ACCESS");
