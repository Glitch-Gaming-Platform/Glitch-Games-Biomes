...
ok(!/validate-harthmere-install-player-ingame-e2e/.test(all), "current scripts do not call stale current validator");
console.log("Harthmere install/player-in-game E2E current validation passed");
