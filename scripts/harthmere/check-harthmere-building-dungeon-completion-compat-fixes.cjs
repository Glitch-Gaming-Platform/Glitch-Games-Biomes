#!/usr/bin/env node
"use strict";
/* HARTHMERE_BUILDING_DUNGEON_COMPLETION_COMPAT_FIXES_TEST */
const fs = require("fs");
...
console.log("== Harthmere building/dungeon completion compatibility fixes tests current ==");
...
check("compat marker exists", src.includes("HARTHMERE_BUILDING_DUNGEON_COMPLETION_COMPAT_FIXES"), "Missing compat marker");
