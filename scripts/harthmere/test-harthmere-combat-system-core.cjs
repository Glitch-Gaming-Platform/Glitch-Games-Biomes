...
console.log("== Harthmere combat system core tests current ==");
console.log(`Root: ${root}\n`);

const source = read("src/shared/harthmere/combat_system.ts");

ok("combat system source exports version", source.includes("HARTHMERE_COMBAT_SYSTEM_VERSION"));
...
ok("party/raid/public contribution is not last-hit-only", includesAll(source, [
  "HarthmereContribution", "damage:", "healing:", "shielding:", "objectives:", "revives:", "crowdControl:", "interrupts:", "tanking:", "support:",
]));
