...
check("current asset marker exists", assets.includes("HARTHMERE_COLLISION_PROFILE_OBSTACLE_EXPORT"));
...
check("actor resolver current exists", assets.includes('placementSystemVersion: "harthmere-town-collision-placement"'));
...
check("current player collision version exists", player.includes('"harthmere-town-collision-profiles"'));
