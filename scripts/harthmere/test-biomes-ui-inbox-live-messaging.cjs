...
console.log('== BiomesUI live inbox / direct messaging current ==');
...
ok(/test-biomes-ui-inbox-live-messaging\.cjs/.test(deploy), 'Production deploy guardrails include live inbox messaging test');
