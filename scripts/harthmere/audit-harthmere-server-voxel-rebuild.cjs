...
const block = main.slice(main.indexOf("HARTHMERE_SERVER_VOXEL_ALL_BUILDINGS_DUNGEONS_VERSION"), main.indexOf("// HARTHMERE_CLEAN_TOWN_REBUILD_END"));
...
console.log(JSON.stringify({
  version: "harthmere-server-voxel-all-buildings-dungeons",
