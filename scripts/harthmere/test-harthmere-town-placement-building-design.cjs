...
console.log("== Harthmere town placement, building, spacing, and NPC invariant tests current ==");
...
check("actor spawn resolver exists", /resolveHarthmereRuntimePlacement/.test(assetsSrc) && /placementSystemVersion: "harthmere-town-collision-placement"/.test(assetsSrc));
