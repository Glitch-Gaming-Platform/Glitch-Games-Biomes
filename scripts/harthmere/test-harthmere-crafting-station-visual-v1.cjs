...
const artifactDir = path.join(root, "artifacts/harthmere-crafting-visual-v1");
  ...
  await writeFile(
    ...
    `
      ...
      function adapter(state: any) {
        const snapshot = normalizeHarthmereCraftingStationClientSnapshotV1(state);
        return createHarthmereCraftingStationAdapterV1({
          state: snapshot,
          hydrated: true,
      ...
      const workbench = adapter({
        ...
        knownRecipes: [
          ...
          ...Object.values(HARTHMERE_CRAFTING_STATION_RECIPE_IDS_V1),
          ...Object.values(HARTHMERE_HOME_DECORATION_RECIPE_IDS_V1),
        ],
        skills: {
          carpentry: { level: 10 },
      ...
      const thermoblaster = adapter({
        ...
        gold: 800,
        inventoryItems: {
          [HARTHMERE_CRAFTING_TOOLS_V1.bucket]: 1,
          [HARTHMERE_CRAFTING_TOOLS_V1.slabber]: 1,
        },
        materialStorage: {
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.antiprotonCapsule]: 20,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.positronCapsule]: 20,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.antineutronCapsule]: 20,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.antihydrogenBlock]: 3,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.antiheliumBlock]: 3,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.antiboronBlock]: 3,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.rawExoticMatter]: 4,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.stabilizedExoticMatter]: 4,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.containmentFilter]: 12,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.coolant]: 6,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.stabilizingCrystal]: 4,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.exoticMatterPowerCell]: 2,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.portalFuel]: 2,
          [HARTHMERE_EXOTIC_MATTER_ITEM_IDS_V1.destinationCrystal]: 2,
          iron_ingot: 8,
          crystal_shard: 8,
        },
        knownRecipes: Object.values(HARTHMERE_EXOTIC_MATTER_RECIPE_IDS_V1),
