...
const src = fs.readFileSync(path.join(root, "src/shared/harthmere/main_quest_spaces.ts"), "utf8");
const spaces = readJsonExport(src, "HARTHMERE_MAIN_QUEST_SPACES_JSON");
...
check("exports space validator", src.includes("validateHarthmereMainQuestSpaces"));
if (process.exitCode) process.exit(process.exitCode);
console.log("RESULT: PASS main quest spaces current");
