...
contains(backend, 'HarthmereLiveModeBankingState', 'Backend has production banking state');
...
contains(backend, 'HARTHMERE_LOAN_DAILY_INTEREST_RATE', 'Backend has daily loan interest');
...
contains(route, 'createHarthmereLiveModeBankingClientSnapshot', 'Bank state route returns client banking snapshot');
