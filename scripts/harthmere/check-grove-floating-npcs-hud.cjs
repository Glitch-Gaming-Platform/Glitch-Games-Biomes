...
ok(staging.includes('whenAllFlags: [CH1_FLAGS.started]') && staging.includes('anchor: "roadhouse_jackie_post"'), "Chapter 1 moves Jackie through the per-player staging layer instead of changing the shared ECS home");
