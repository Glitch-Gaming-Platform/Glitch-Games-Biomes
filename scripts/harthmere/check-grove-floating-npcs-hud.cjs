...
ok(grove.includes("SNAPSHOT_GROVE_LIVE_WORLD_GROUND_Y = 69") && grove.includes("SNAPSHOT_GROVE_LIVE_NPC_FEET_Y"), "Grove live NPC feet stay on the y=70 installed-snapshot fountain band");
...
ok(npcs.includes("SNAPSHOT_GROVE_NPC_ASSET_KEY_VERSION") && npcs.includes('jackie: "npcs/jackie"') && npcs.includes('taye: "npcs/taye"'), "seeded Grove NPCs prefer their upstream snapshot GLB avatar assets");
