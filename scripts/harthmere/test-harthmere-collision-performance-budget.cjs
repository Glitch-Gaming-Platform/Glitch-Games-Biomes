#!/usr/bin/env node
"use strict";
/* HARTHMERE_COLLISION_PERFORMANCE_BUDGET_STRICT_RUNTIME */
const fs = require("fs");
...
console.log("== Harthmere collision performance budget tests current ==");
...
if (/HARTHMERE_COLLISION_BROADPHASE|BROADPHASE_CELL_SIZE|getHarthmereLocalDevHorizontalBroadphaseCandidates/.test(player)) {
...
if (/HARTHMERE_COLLISION_PERFORMANCE_BUDGET|MAX_CANDIDATES|MAX_SWEEP_CHECKS|PERFORMANCE_MAX/.test(player)) {
