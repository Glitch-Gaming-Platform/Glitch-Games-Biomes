...
const libPath = path.join(root, "scripts/harthmere/harthmere-third-party-combat-ai-test-lib.cjs");
const sourcePath = path.join(root, "src/shared/harthmere/third_party_combat_ai.ts");
