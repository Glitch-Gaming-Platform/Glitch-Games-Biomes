#!/usr/bin/env node
const { checkFactory, dialogueFacingSources } = require("./harthmere-dialogue-rule-test-lib.cjs");
const root = process.argv[2] || process.cwd();
const { check, finish } = checkFactory();
console.log("== Harthmere dialogue no development/meta text tests current ==");
