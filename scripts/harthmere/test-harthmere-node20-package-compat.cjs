...
console.log('== Harthmere Node 20 package compatibility tests current ==');
...
check('Kubernetes client stays below 1.x to avoid ESM-only migration in the current dependency set', /^\^?0\.22\.3/.test(dep('@kubernetes/client-node')));
