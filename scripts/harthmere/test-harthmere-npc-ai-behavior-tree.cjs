#!/usr/bin/env node
const { createHarness, aiSource } = require("./harthmere-npc-ai-test-lib.cjs");
const h = createHarness("Harthmere NPC AI behavior tree tests current"); const src = aiSource(h);
