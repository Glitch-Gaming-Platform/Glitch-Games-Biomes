...
echo 'Step 1/6: validate v123 test files'
node scripts/harthmere/validate-harthmere-install-player-ingame-e2e-v123.cjs "$REPO"
...
bash scripts/harthmere/test-harthmere-install-player-ingame-e2e-v123.sh "$REPO"
