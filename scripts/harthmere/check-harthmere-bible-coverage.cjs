...
console.log('Harthmere Bible Coverage + District Identity Audit current');
console.log(`Repo: ${root}`);
console.log(`Mode: ${strict ? 'STRICT' : 'report'}`);
console.log(`Runtime: ${runtimePath}`);

printHeader('Structural audit');
expectCritical(runtime.includes('HARTHMERE_FULL_TOWN_REBUILD_START'), 'runtime contains full town rebuild marker', 'Expected the current Harthmere placement pass to be present.');
