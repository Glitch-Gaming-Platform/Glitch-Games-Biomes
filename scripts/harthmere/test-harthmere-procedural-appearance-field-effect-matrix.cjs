...
const expectedBodyEffects = [
  ...
  ["bodyHeight", metricsBody + createTownBody, ["heightScale", "heightDelta", "const torsoHeight", "const legLength", "harthmereBodyHeightScaleAppliedToMetrics"]],
  ...
  ["outfitColor", outfitTintBody + legTintBody + createTownBody, ["appearance.body.outfitColor", "outfitTint", "legTint"]],
];
...
const expectedFaceEffects = [
  ["skinTone", ["skin"]],
  ["faceShape", ["harthmereRuntimeFaceShapeMetrics"]],
