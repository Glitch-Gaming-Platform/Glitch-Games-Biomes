...
ok("NPC renderer prioritizes player-like generated mesh path before local-dev fallback", src.npcResources.indexOf("if (npcType.isPlayerLikeAppearance)") > -1 && src.npcResources.indexOf("if (npcType.isPlayerLikeAppearance)") < src.npcResources.indexOf("const localDevOffset = localDevNpcOffset(id)"));
