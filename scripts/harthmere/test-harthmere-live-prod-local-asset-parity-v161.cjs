...
// HARTHMERE_LIVE_PROD_LOCAL_ASSET_PARITY_V161
...
if (!origin) {
  console.error("usage: node scripts/harthmere/test-harthmere-live-prod-local-asset-parity-v161.cjs https://your-origin");
  process.exit(2);
}
