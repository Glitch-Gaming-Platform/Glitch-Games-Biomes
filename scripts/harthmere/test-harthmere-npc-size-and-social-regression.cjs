...
console.log("== Harthmere NPC size/social regression tests current ==");
...
ok(
  ...
  /harthmereBaseScaleBeforeHit/.test(npcs) && /baseScale\[0\] \* meshScale/.test(npcs) && /baseScale\[1\] \* meshScale/.test(npcs) && /baseScale\[2\] \* meshScale/.test(npcs),
