...
const structureManifest = JSON.parse(fs.readFileSync(path.join(root, "public/harthmere-debug/harthmere-server-voxel-structure-manifest.json"), "utf8"));
const housingManifest = JSON.parse(fs.readFileSync(path.join(root, "public/harthmere-debug/harthmere-npc-housing.json"), "utf8"));
const byDistrict = {};
...
console.log(JSON.stringify({
  version: "harthmere-server-voxel-occupancy",
