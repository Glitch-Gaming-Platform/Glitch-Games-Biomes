...
if (fs.existsSync(lockPath)) {
  ...
  if (/@silevis\/reactgrid/.test(lock) && /"version"\s*:\s*"4\.0\.3"/.test(lock)) {
    console.log('INFO package-lock still references @silevis/reactgrid 4.0.3; run npm install or scripts/harthmere/install-harthmere-ai-deps.sh to refresh the lockfile.');
  }
