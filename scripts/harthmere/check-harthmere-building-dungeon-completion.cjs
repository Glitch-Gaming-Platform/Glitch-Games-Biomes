#!/usr/bin/env node
"use strict";
/* HARTHMERE_BUILDING_DUNGEON_COMPLETION_TEST */
const fs = require("fs");
...
console.log("== Harthmere building/dungeon completion tests current ==");
...
check("completion marker exists", src.includes("HARTHMERE_BUILDING_DUNGEON_COMPLETION"), "Missing HARTHMERE_BUILDING_DUNGEON_COMPLETION");
...
const markerIndex = src.indexOf("HARTHMERE_BUILDING_DUNGEON_COMPLETION");
