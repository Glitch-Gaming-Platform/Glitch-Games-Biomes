...
console.log("== Harthmere all-weapon animation runtime tests current ==");
...
ok("renderer declares weapon-wide catalog marker", has(assets, "harthmere-all-weapon-animation"));
...
console.log("\nWeapon-like equipment covered by current:");
