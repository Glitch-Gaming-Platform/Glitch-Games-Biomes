...
const scripts = [
  "scripts/harthmere/test-biomes-ui-vitals.cjs",
  "scripts/harthmere/test-biomes-ui-replacement-edge-cases.cjs",
  "scripts/harthmere/test-biomes-ui-full-replacement-readiness.cjs",
];
...
if (process.env.BIOMES_UI_BROWSER_URL || process.env.BIOMES_UI_RUN_BROWSER_SMOKE === "1") {
  console.log("\n=== scripts/harthmere/test-biomes-ui-browser-smoke.cjs ===");
  const args = ["scripts/harthmere/test-biomes-ui-browser-smoke.cjs"];
  ...
  console.log("BIOMES_UI_RUN_BROWSER_SMOKE=1 node scripts/harthmere/test-biomes-ui-all.cjs .");
