#!/usr/bin/env node
/**
 * index-local-static-bucket-assets.cjs
 *
 ...
 *   side tryServeGlitchLocalBucketAsset handler checks:
 ...
 *   node scripts/harthmere/index-local-static-bucket-assets.cjs [repo-root]
 *
...
console.log("HARTHMERE_PROD_ASSET_LOCAL_INDEX");
