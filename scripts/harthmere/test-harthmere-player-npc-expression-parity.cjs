...
check("NPCs expose body/face/clothing diagnostics", runtime.includes("harthmereRuntimeOutfitColor") && runtime.includes("harthmereForceProceduralTownspersonClothingKeys"));
