...
const legacyCheck = path.join(root, "scripts/harthmere/check-harthmere-craftsman-row-black-anvil.cjs");
...
console.log("== Harthmere Craftsman Row exterior identity current ==");
...
ok(
  "old current-breaking banner wording is gone",
...
ok(
  "town placement suite includes current Craftsman Row exterior identity regression",
  suite.includes('"test-harthmere-craftsman-row-exterior-identity.cjs"') ||
    suite.includes("'test-harthmere-craftsman-row-exterior-identity.cjs'")
);
