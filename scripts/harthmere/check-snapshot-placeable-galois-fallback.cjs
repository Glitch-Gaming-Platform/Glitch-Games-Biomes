...
ok(helpers.includes('GLITCH_SNAPSHOT_PLACEABLE_GALOIS_FALLBACK'), 'placeable fallback marker is present');
...
console.log('snapshot placeable galois fallback current check passed');
