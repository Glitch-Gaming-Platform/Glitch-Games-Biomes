...
check("new runtime clothing function is unconditional and role colored", runtime.includes("addHarthmereRuntimeAlwaysVisibleNpcClothing") && runtime.includes("runtime-always-visible-clothing-torso-front"));
