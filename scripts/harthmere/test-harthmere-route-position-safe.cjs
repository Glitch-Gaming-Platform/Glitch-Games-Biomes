...
check('current route-position-safe marker exists', src.includes('harthmere-route-position-safe-negative-progress'));
...
check('route helper validates missing or malformed route points', /isHarthmereValidRoutePoint/.test(src) && /firstHarthmereValidRoutePoint/.test(src));
