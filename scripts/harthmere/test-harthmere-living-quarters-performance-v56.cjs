...
ok((/return createHarthmereLivingQuarterVoxelShellV56\(building\);/.test(assets) || /BUILDING_V2_VOXEL_MESHES whole voxel building mesh/.test(assets)), "resident story frames use v56 instead of v49 dense shell");
...
ok((/v56 service two-story completion walkable stair tread/.test(assets) || /createHarthmereServiceBlockStairRunV43\(building, floor\)/.test(assets)), "v56 service buildings add walkable stairs");
