...
const report = makeReporter("Harthmere animation asset / GLTF coverage tests current", root);
...
function isGitLfsPointer(file) {
  ...
  return head.startsWith("version https://git-lfs.github.com/spec/current");
}
