...
const checks = [
  ...
  ["disabled-by-default marker exists", "HARTHMERE_LOCAL_DEV_PLAYER_TOWN_COLLISION_DISABLED_BY_DEFAULT"],
...
if (src.includes("intersectLocalDevHarthmereTownCollision([boxMin, boxMax], fn);\n") && !src.includes("__harthmereEnablePlayerTownCollision")) {
