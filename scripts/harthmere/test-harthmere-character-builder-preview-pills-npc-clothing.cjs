...
check("runtime has outside clothing shell function", runtime.includes("addHarthmereRuntimeOutsideClothingShell"));
...
check("procedural townspeople call outside clothing shell", runtime.includes("addHarthmereRuntimeOutsideClothingShell(root, appearance.clothing, body, palette);"));
