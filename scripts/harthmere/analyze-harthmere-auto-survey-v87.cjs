#!/usr/bin/env node
// BIOMES_HARTHMERE_SURVEY_ANALYZER_V87
// Reads a harthmere-auto-survey-v84 JSON capture and summarizes the locations
...
if (!file) {
  console.error('Usage: node scripts/harthmere/analyze-harthmere-auto-survey-v87.cjs <harthmere-auto-survey.json>');
  process.exit(1);
}
...
console.log('BIOMES_HARTHMERE_SURVEY_ANALYZER_V87');
