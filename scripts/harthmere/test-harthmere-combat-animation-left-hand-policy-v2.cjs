...
check("NPC weapon fallback anchor is left hand", () => assert(/ensureHarthmereNpcPolishedWeaponAnchorV1[\s\S]{0,700}harthmere-anchor-left-hand/.test(renderer) && /attachHarthmereNpcWeaponVisual[\s\S]{0,3200}(?:harthmere-anchor-left-hand|npcMainHandAnchorNameV3)[\s\S]{0,520}anchor\.add\(visual\)/.test(renderer), "NPC main weapon not on left anchor"));
