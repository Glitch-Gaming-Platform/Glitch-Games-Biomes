...
def update_manifest(path):
    ...
    data['clips']=clips; data['clipCount']=len(clips); data['version']=VERSION; data['alignedBodyWeaponClips']=list(CLIPS.keys()); data['alignedBodyWeaponFrameCount']=FRAME_COUNT
