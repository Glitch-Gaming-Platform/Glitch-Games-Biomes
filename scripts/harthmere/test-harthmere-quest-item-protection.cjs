...
const { createHarness, inventorySource, questEconomySource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere quest item protection tests current");
