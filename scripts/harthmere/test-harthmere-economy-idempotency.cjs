...
const { createHarness, inventorySource, economySource, hardeningSource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere economy idempotency current");
...
h.ok(hard.includes("rapidEconomyActions"), "rapid action ledger uses a versioned localStorage key");
