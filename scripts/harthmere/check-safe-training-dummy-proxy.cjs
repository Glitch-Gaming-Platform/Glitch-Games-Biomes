...
check("safe training dummy proxy marker exists", text.includes("harthmere-training-dummy-visual-proxy"));
...
check("old inserted 9001 placement marker removed", !text.includes("harthmere-training-dummy-combat-actor"));
