#!/usr/bin/env node
const { createHarness, aiSource, planGridPath, steer } = require("./harthmere-npc-ai-test-lib.cjs");
const h = createHarness("Harthmere NPC AI navigation tests current"); const src = aiSource(h);
