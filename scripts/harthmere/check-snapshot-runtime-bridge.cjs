...
ok(s.includes('SNAPSHOT_RUNTIME_BRIDGE'),'runtime bridge marker is present');
...
const bridgeIdx=s.indexOf('SNAPSHOT_RUNTIME_BRIDGE');
...
console.log('snapshot runtime bridge current check passed');
