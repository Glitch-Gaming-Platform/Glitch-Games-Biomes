...
const testFiles = [
  "scripts/harthmere/test-harthmere-npc-visual-expression.cjs",
  "scripts/harthmere/test-harthmere-procedural-body-face-clothing-behavior.cjs",
  "scripts/harthmere/test-harthmere-procedural-appearance-field-effect-matrix.cjs",
];
