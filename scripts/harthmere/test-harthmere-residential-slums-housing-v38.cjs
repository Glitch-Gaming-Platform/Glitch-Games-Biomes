...
reporter.check("current authored NPC count is recorded", actors.length === 194 && /HARTHMERE_RESIDENT_HOUSING_EXPECTED_NPC_COUNT_V38\s*=\s*194/.test(manifest), `actors=${actors.length}`);
