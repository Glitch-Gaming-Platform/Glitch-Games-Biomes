#!/usr/bin/env node
"use strict";
/* HARTHMERE_BELLBOUND_MISSING_DETAILS_EXPANSION_TEST */
const fs = require("fs");
...
console.log("== Harthmere Bellbound missing-detail expansion tests current ==");
...
const marker = "// HARTHMERE_BELLBOUND_MISSING_DETAILS_EXPANSION";
...
check("Bellbound missing-details expansion marker exists", markerIndex >= 0, "Missing HARTHMERE_BELLBOUND_MISSING_DETAILS_EXPANSION");
