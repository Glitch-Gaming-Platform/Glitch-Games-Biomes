...
ok(animation.includes('HARTHMERE_ANIMATION_TARGET_PRUNING') || animation.includes('animationTrackCanBindToMesh'), 'animation target-pruning coverage is still present');
