...
console.log('== Harthmere AI dependency install no peer bypass tests current ==');
...
check('installer runs Stylelint cleanup compatibility test', text.includes('test-harthmere-stylelint15-prettier-cleanup.cjs'));
