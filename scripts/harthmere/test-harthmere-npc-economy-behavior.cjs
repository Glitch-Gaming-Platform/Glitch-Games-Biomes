...
const { createHarness, npcBehaviorSource, vendorSource, challengeSource } = require("./harthmere-economy-test-lib.cjs");
const h = createHarness("Harthmere NPC economy behavior tests current");
