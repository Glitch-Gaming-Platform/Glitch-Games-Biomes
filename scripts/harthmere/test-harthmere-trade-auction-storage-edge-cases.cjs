...
console.log("== Harthmere trade/auction/storage edge case tests current ==");
...
check("all new systems use versioned localStorage keys", trade.includes("tradeAuctionState") && storage.includes("storageMailRecoveryState"));
finish();
