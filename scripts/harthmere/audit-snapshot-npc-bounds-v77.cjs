 ...
 * SNAPSHOT_NPC_VISUAL_BOUNDS_PASS_V77
...
const out = process.argv[3] ? path.resolve(process.argv[3]) : path.join(root, 'tmp/snapshot-npc-bounds-v77.json');
...
const result = {
  version: 'snapshot-grove-npc-visual-bounds-pass-v77',
  root,
