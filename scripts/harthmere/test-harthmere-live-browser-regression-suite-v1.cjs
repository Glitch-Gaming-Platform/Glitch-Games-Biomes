#!/usr/bin/env node
"use strict";
/* HARTHMERE_LIVE_BROWSER_REGRESSION_SUITE_V2_STRICT_RUNTIME */
...
const tests = [
  "test-harthmere-browser-player-collision-e2e-v1.cjs",
  "test-harthmere-dungeon-console-teleport-live-v1.cjs",
  "test-harthmere-collision-overlay-screenshot-audit-v1.cjs",
...
console.log("== Harthmere live browser/runtime regression suite v2 ==");
