#!/usr/bin/env node
const { createHarness, aiSource, npcSystemSource, assertAiModuleBasics } = require("./harthmere-npc-ai-test-lib.cjs");
const h = createHarness("Harthmere NPC AI stack contract tests current");
