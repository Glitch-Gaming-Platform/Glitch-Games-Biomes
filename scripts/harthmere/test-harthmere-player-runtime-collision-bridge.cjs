...
console.log("== Harthmere player runtime collision bridge tests current ==");
...
check(
  ...
  player.includes("HARTHMERE_PLAYER_TOWN_COLLISION_RUNTIME_BRIDGE_ENABLED"),
...
check(
  ...
  suite.includes("test-harthmere-player-runtime-collision-bridge.cjs"),
