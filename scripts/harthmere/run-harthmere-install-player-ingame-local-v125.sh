...
echo 'Step 1/6: validate v125 test files'
node scripts/harthmere/validate-harthmere-install-player-ingame-e2e-v125.cjs "$REPO"
...
bash scripts/harthmere/test-harthmere-install-player-ingame-e2e-v125.sh "$REPO"
