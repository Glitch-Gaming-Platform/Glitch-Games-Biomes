...
ok(s.includes("SNAPSHOT_COLLISION_MISSING_AABB_COMPAT"), "collision missing-AABB compatibility marker is present");
ok(s.includes("warnMissingCollisionAabb"), "missing-AABB warning helper exists");
...
console.log("snapshot collision missing-AABB compatibility current check passed");
