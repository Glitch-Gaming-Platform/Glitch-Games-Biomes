...
console.log("== Building System v6 typecheck hotfix ==");
...
const shared = read("src/shared/harthmere/building_system_v1.ts");
ok(shared.includes("recurringDemand: readonly string[]"), "business recurringDemand type accepts readonly catalogue arrays");
ok(shared.includes("connectedBusinesses: readonly BuildingSystemBusinessTypeV1[]"), "business connectedBusinesses type accepts readonly catalogue arrays");
