...
const PLACEMENTS: RuntimePlacement[] = [
  ...
  P("table_large_fp", 558.4, -262.2, 0, 0.42, "Bridge crack planning table inside Reeve Hall civic room", "Noble Rise"),
  ...
  P("cauldron_fp", 529.2, -231.0, 0, 0.34, "Bell-bronze alloy crucible on floor in Black Anvil back bay", "Craftsman Row"),
  ...
  P("table_large_fp", 596.0, -178.8, 0, 0.36, "Reeve Hall public hearing table inside civic chamber", "Noble Rise"),
  ...
  P("bed_twin1", 409.0, -158.4, Math.PI / 2, 0.3, "Mudden Poorhouse second sleeping pallet against shared wall", "Mudden Ward"),
  P("table_medium", 410.4, -158.2, 0, 0.24, "Mudden Poorhouse communal table with clear door lane", "Mudden Ward"),
  P("candle_1_fp", 410.4, -158.2, 0, 0.12, "Mudden Poorhouse candle supported on communal table", "Mudden Ward", GROUND_Y + 0.52),
