...
const ASSETS: RuntimeAsset[] = [
  ...
  fbx("food_apple", "fbx/props/food/quaternius_ultimate_food/Apple.fbx", 0.45),
  fbx("food_green_apple", "fbx/props/food/quaternius_ultimate_food/Apple_Green.fbx", 0.45),
  fbx("food_carrot", "fbx/props/food/quaternius_ultimate_food/Carrot.fbx", 0.42),
  fbx("food_mushroom", "fbx/props/food/quaternius_ultimate_food/Mushroom.fbx", 0.48),
...
const PLACEMENTS: RuntimePlacement[] = [
  ...
  A("townsperson_market", 548, -191, Math.PI, 1.22, "Elowen Pike tavern loop", "Copper Kettle", { radius: 3.1, speed: 0.23, phase: 2.8 }),
