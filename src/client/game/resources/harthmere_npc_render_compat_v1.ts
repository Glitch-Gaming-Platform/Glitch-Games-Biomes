// HARTHMERE_NPC_RENDER_COMPONENT_COMPAT_V1
//
...
export const HARTHMERE_NPC_RENDER_COMPONENT_COMPAT_VERSION_V1 =
  "harthmere-npc-render-component-compat-v1";
...
// SNAPSHOT_OVERLAY_ENTITY_SIZE_COMPAT_V68 in scripts/overlays.ts), so those NPCs
...
export function harthmereEnsureRenderableNpcEntityV1(
  entity: ReadonlyEntity
