...
import { HarthmereBusinessShiftControlPane } from "./HarthmereBusinessShiftControlPane";
...
// The detached card "arena" that used to cover the 3D room is gone; customer
// service is spatial, beside the real ECS customer. Its container style went
// with it. The remaining mini-game styles below still dress the definition
// summary shown on the Services tab, which is descriptive copy rather than a
// playable surface.
