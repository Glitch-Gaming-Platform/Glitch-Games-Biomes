export const BIOMES_UI_ACTIVE_MINIMAP_PIN_STYLE_ID_V146 =
  "biomes-ui-active-minimap-pin-v146";

export const BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146 =
  "biomes-ui-active-minimap-pin-v146";
...
export function biomesUIActiveMiniMapPinHasFinitePositionV146(
  position: unknown
...
export function biomesUIActiveMiniMapPinClassNameV146(
  isClippedToEdge: boolean
): string {
  return [
    BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146,
    isClippedToEdge ? BIOMES_UI_ACTIVE_MINIMAP_PIN_EDGE_CLASS_V146 : "",
  ]
    .filter(Boolean)
    .join(" ");
}

export function biomesUIActiveMiniMapPinCssV146(): string {
  return `
@keyframes biomesUIActiveMiniMapPinPulseV146 {
...
.${BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146}__halo {
  animation: biomesUIActiveMiniMapPinPulseV146 1.25s ease-in-out infinite;
...
.${BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146}__tail {
...
.${BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146}__core {
...
.${BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146}__dot {
...
.${BIOMES_UI_ACTIVE_MINIMAP_PIN_EDGE_CLASS_V146} .${BIOMES_UI_ACTIVE_MINIMAP_PIN_ROOT_CLASS_V146}__tail {
