...
import { harthmereObjectiveMiniMapPinsFromLandmarksV1 } from "../harthmere_objective_minimap_pins_v1";

// HARTHMERE_OBJECTIVE_MINIMAP_PINS_V1
describe("harthmereObjectiveMiniMapPinsFromLandmarksV1", () => {
  it("maps accepted-job / helper-quest landmarks to minimap pins", () => {
    const pins = harthmereObjectiveMiniMapPinsFromLandmarksV1([
