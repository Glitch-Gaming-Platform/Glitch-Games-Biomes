...
export const HARTHMERE_VENDOR_CATALOG: Record<number, HarthmereUnifiedVendorProfile> = {
  ...
  6: vendor({
    ...
    buys: ["trade_good", "junk", "currency", "event_item", "crafting_material", "tool", "luxury"],
  ...
  8: vendor({
    ...
    buys: ["consumable", "food", "crafting_material", "spell_scroll", "tool", "junk", "trade_good"],
  ...
  9: vendor({
    ...
    buys: ["spell_scroll", "book", "crafting_material", "quest_item", "tool", "junk", "trade_good", "luxury"],
