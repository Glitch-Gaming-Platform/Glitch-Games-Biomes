...
const VENDOR_PROFILES: Record<number, VendorEconomyProfile> = {
  5: {
    offset: 5,
    ...
    region: "harthmere",
    sells: [
      { itemId: "apple_tart", quantity: 2 },
      { itemId: "road_ration", quantity: 3 },
    ],
    buysCategories: ["food", "trade_good"],
    baseSellModifier: 1.16,
    baseBuyModifier: 0.58,
    goldSupply: 350,
    restockHours: 8,
    refusesStolenGoods: true,
  },
  6: {
    offset: 6,
    vendorId: "harthmere_bank",
    name: "Harthmere Bank",
    vendorType: "banker",
    region: "harthmere",
    sells: [{ itemId: "iron_key_blank", quantity: 1 }],
    buysCategories: ["trade_good", "luxury", "crafting_material"],
  ...
  7: {
    offset: 7,
    vendorId: "weapons_teller",
    name: "Weapons Teller",
    vendorType: "weapon_vendor",
    region: "harthmere",
    sells: [
      { itemId: "training_dagger", quantity: 1 },
      { itemId: "iron_longsword", quantity: 1 },
      { itemId: "wooden_shield", quantity: 1 },
    ],
    buysCategories: ["weapon", "armor", "crafting_material"],
  ...
  8: {
    ...
    sells: [
      ...
      { itemId: "field_revival_scroll", quantity: 1 },
    ],
    buysCategories: ["consumable", "trade_good"],
  ...
  11: {
    ...
    sells: [
      { itemId: "road_ration", quantity: 3 },
      { itemId: "copper_kettle_token", quantity: 1 },
    ],
    buysCategories: ["food", "trade_good", "junk"],
  ...
  29: {
    ...
    sells: [
      { itemId: "iron_longsword", quantity: 1 },
      { itemId: "wooden_shield", quantity: 1 },
      { itemId: "cold_iron_scrap", quantity: 5 },
    ],
    buysCategories: ["weapon", "armor", "crafting_material"],
    baseSellModifier: 1.2,
  ...
  30: {
    offset: 30,
    vendorId: "elowen_pike_innkeeper",
    name: "Elowen Pike",
    vendorType: "innkeeper",
    region: "harthmere",
    sells: [
      { itemId: "road_ration", quantity: 4 },
      { itemId: "apple_tart", quantity: 2 },
      { itemId: "copper_kettle_token", quantity: 1 },
    ],
    buysCategories: ["food", "trade_good"],
  ...
  31: {
    ...
    buysCategories: ["consumable", "luxury", "trade_good"],
  ...
  34: {
    offset: 34,
    vendorId: "river_docks",
    name: "River Docks",
    vendorType: "trade_goods",
    region: "harthmere",
    sells: [
      { itemId: "road_ration", quantity: 3 },
      { itemId: "apple_basket", quantity: 1 },
    ],
    buysCategories: ["trade_good", "food", "crafting_material"],
  ...
  47: {
    ...
    sells: [
      ...
      { itemId: "fever_tea_bundle", quantity: 1 },
      { itemId: "field_revival_scroll", quantity: 1 },
    ],
    buysCategories: ["consumable", "trade_good", "crafting_material"],
    baseSellModifier: 1.2,
    baseBuyModifier: 0.55,
    goldSupply: 900,
    restockHours: 12,
  ...
  63: {
    offset: 63,
    vendorId: "ren_orchard",
    name: "Apple Picker Ren",
    vendorType: "farmer",
    region: "harthmere",
    sells: [{ itemId: "apple_basket", quantity: 1 }],
    buysCategories: ["food", "trade_good"],
  ...
  67: {
    ...
    vendorType: "blacksmith",
    region: "harthmere",
    sells: [{ itemId: "cold_iron_scrap", quantity: 3 }],
    buysCategories: ["crafting_material", "weapon", "armor"],
...
const BLACK_MARKET_OFFSETS = new Set([33, 34, 65, 70]);
