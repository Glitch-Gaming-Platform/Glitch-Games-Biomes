...
function nodesForNpc(offset: number) {
  const byOffset: Record<number, string[]> = {
    ...
    42: ["harthmere_north_iron_vein", "harthmere_orchard_softwood"],
    ...
    8: ["harthmere_temple_peacebloom", "harthmere_chapel_relic_dig"],
    10: ["harthmere_old_well_essence", "harthmere_chapel_relic_dig"],
    13: ["harthmere_river_fishing_pool", "harthmere_river_clay"],
    14: ["harthmere_mudden_scrap", "harthmere_old_well_essence"],
    16: ["harthmere_farm_crops", "harthmere_orchard_softwood"],
    27: ["harthmere_wolf_carcass", "harthmere_north_iron_vein"],
  };
