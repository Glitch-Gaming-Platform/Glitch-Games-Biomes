...
describe("live-entity helper dialog context", () => {
  ...
  it("maps every authored Grove world object to its intended F-key action", () => {
    ...
    const expected: Record<string, [string, string]> = {
      "Antler Track Rubbing": ["gather", "Take Rubbing"],
      "Berry Patch": ["gather", "Gather"],
      "Billy's Drop Post": ["read", "Read"],
      "Billy's Lunch Pail": ["gather", "Pick Up"],
      ...
      "Gus's Marked Loaf Basket": ["gather", "Pick Up"],
      ...
      "High Moss Song Stone": ["inspect", "Inspect"],
      ...
      "Middle Moss Song Stone": ["inspect", "Inspect"],
      ...
      "Sil's Tuning Strip": ["gather", "Pick Up"],
      "Silent Warning Moss Patch": ["gather", "Gather"],
      "Softwood Practice Dummy": ["practice", "Practice"],
      "Taye's Paint Pot": ["use", "Use Pot"],
      "Warning Moss Patch": ["gather", "Gather"],
      "West Pigment Muck Clump": ["gather", "Gather"],
      "West Warning Moss Patch": ["gather", "Gather"],
    };
