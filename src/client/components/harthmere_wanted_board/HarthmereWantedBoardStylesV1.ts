...
export const HARTHMERE_WANTED_BOARD_STYLES_ID_V1 =
  "harthmere-wanted-board-styles-v1";

export const HARTHMERE_WANTED_BOARD_CSS_V1 = `
...
export function installHarthmereWantedBoardStylesV1(): void {
  if (typeof document === "undefined") return;
  installBiomesUITheme();
  if (document.getElementById(HARTHMERE_WANTED_BOARD_STYLES_ID_V1)) return;
  const style = document.createElement("style");
  style.id = HARTHMERE_WANTED_BOARD_STYLES_ID_V1;
  style.setAttribute("data-source", "harthmere_wanted_board");
  style.appendChild(document.createTextNode(HARTHMERE_WANTED_BOARD_CSS_V1));
