...
export const HARTHMERE_PLACED_COOK_STATION_RE_V1 =
...
// HARTHMERE_PLACED_COOK_STATION_PROMPT_V1
// Decides whether a *placed placeable* should get the "F" cook prompt at all.
// This is deliberately TIGHTER than HARTHMERE_PLACED_COOK_STATION_RE_V1 above:
...
const HARTHMERE_PLACED_COOK_STATION_PROMPT_RE_V1 =
...
export interface HarthmereCookStationItemLikeV1 {
  id?: BiomesId | number;
...
export function isHarthmerePlacedCookStationItemV1(
  item: HarthmereCookStationItemLikeV1 | undefined | null
): boolean {
  if (!item) {
    return false;
  }
  ...
  return HARTHMERE_PLACED_COOK_STATION_PROMPT_RE_V1.test(text);
}
