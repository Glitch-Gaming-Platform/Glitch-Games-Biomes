...
// Wide Harthmere Wilds shard bounds.
// v13 keeps the fast one-ground-layer seed, but adds a wide safety skirt around
// the v12 playable area. The previous 0..992 / -736..256 bounds were easy to
// reach during testing; stepping into unloaded terrain at the visible edge could
// wedge the local player. These bounds give the forest room in every direction
// while staying below the local-dev terrain ID budget and Redis apply limit.
const STARTER_TOWN_WILDS_SHARD_X0 = -8;
const STARTER_TOWN_WILDS_SHARD_X1 = 38;
const STARTER_TOWN_WILDS_SHARD_Z0 = -31;
const STARTER_TOWN_WILDS_SHARD_Z1 = 15;
...
async function seedLocalDevTerrainIfMissing(
  ...
  log.warn("Seeding local dev starter town terrain", {
    contentPass: "harthmere-town-design-rebuild-v16-fast-harvestable-debug",
