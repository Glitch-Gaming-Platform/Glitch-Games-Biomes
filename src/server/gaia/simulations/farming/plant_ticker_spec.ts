...
import type { BaseFarmingPlantTicker } from "@/server/gaia/simulations/farming/plant_ticker";
import { FarmingVariantPlantTicker } from "@/server/gaia/simulations/farming/plant_variant_ticker";
