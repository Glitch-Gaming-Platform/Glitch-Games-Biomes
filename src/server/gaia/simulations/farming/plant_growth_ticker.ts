...
import type {
  ...
  GrowthFarmingStage,
} from "@/server/gaia/simulations/farming/plant_ticker_spec";
import { farmLog } from "@/server/gaia/simulations/farming/util";
import { FarmingPlantTerrainModifier } from "@/server/gaia/simulations/farming/terrain_modifier";
import { GrowthTransition } from "@/server/gaia/simulations/farming/growth";
