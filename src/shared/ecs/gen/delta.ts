...
// Content Hash: a0d144268518a92f863da844779e0cdc
...
export abstract class ReadonlyDelta {
  ...
  asReadonlyEntity(): ReadonlyEntity {
    ...
    {
      const component = this.movementState();
      if (component !== undefined) {
        entity.movement_state = component;
      }
    }
    return entity;
  }
...
export abstract class Delta extends ReadonlyDelta {
  ...
  setMovementState(x: c.MovementState) {
    (this.delta ??= {}).movement_state = x;
  }

  clearMovementState() {
    (this.delta ??= {}).movement_state = null;
  }
...
export class EntityBackedDelta extends Delta {
  ...
  movementState(): c.ReadonlyMovementState | undefined {
    ...
    return this.entity.movement_state;
  }
}
...
export class DeltaPatch extends Delta {
  ...
  movementState(): c.ReadonlyMovementState | undefined {
    ...
    return this.parent.movementState();
  }
