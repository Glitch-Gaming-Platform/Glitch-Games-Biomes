...
export class NpcCombatStateSerde {
  static serialize(component: c.ReadonlyNpcCombatState) {
    ...
    if (component.ranged_attack_ability_id !== null) {
      data[2 - 1] = component.ranged_attack_ability_id;
    }
    if (component.ranged_attack_projectile_visual_id !== null) {
      data[3 - 1] = component.ranged_attack_projectile_visual_id;
    }
    if (component.ranged_attack_cast_time !== null) {
      data[4 - 1] = component.ranged_attack_cast_time;
    }
    if (component.ranged_attack_aim_point !== null) {
      data[5 - 1] = component.ranged_attack_aim_point;
    }
    if (component.ranged_attack_result !== null) {
      data[6 - 1] = component.ranged_attack_result;
    }
    if (component.ranged_attack_charge_time_secs !== null) {
      data[7 - 1] = component.ranged_attack_charge_time_secs;
    }
  ...
  static deserialize(data: any): c.NpcCombatState {
    ...
    if (!Array.isArray(data)) {
      ...
      if (data[2] !== undefined) {
        fields.ranged_attack_ability_id = t.deserializeOptionalString(data[2]);
      } else if (data.ranged_attack_ability_id !== undefined) {
        fields.ranged_attack_ability_id = t.deserializeOptionalString(
          data.ranged_attack_ability_id
        );
      }
      if (data[3] !== undefined) {
        fields.ranged_attack_projectile_visual_id = t.deserializeOptionalString(
          data[3]
        );
      } else if (data.ranged_attack_projectile_visual_id !== undefined) {
        fields.ranged_attack_projectile_visual_id = t.deserializeOptionalString(
          data.ranged_attack_projectile_visual_id
        );
      }
      if (data[4] !== undefined) {
        fields.ranged_attack_cast_time = t.deserializeOptionalF64(data[4]);
      } else if (data.ranged_attack_cast_time !== undefined) {
        fields.ranged_attack_cast_time = t.deserializeOptionalF64(
          data.ranged_attack_cast_time
        );
      }
      if (data[5] !== undefined) {
        fields.ranged_attack_aim_point = t.deserializeOptionalVec3f(data[5]);
      } else if (data.ranged_attack_aim_point !== undefined) {
        fields.ranged_attack_aim_point = t.deserializeOptionalVec3f(
          data.ranged_attack_aim_point
        );
      }
      if (data[6] !== undefined) {
        fields.ranged_attack_result = t.deserializeOptionalString(data[6]);
      } else if (data.ranged_attack_result !== undefined) {
        fields.ranged_attack_result = t.deserializeOptionalString(
          data.ranged_attack_result
        );
      }
      if (data[7] !== undefined) {
        fields.ranged_attack_charge_time_secs = t.deserializeOptionalF64(
          data[7]
        );
      } else if (data.ranged_attack_charge_time_secs !== undefined) {
        fields.ranged_attack_charge_time_secs = t.deserializeOptionalF64(
          data.ranged_attack_charge_time_secs
        );
      }
      if (data[8] !== undefined) {
        fields.ranged_attack_release_time = t.deserializeOptionalF64(data[8]);
      } else if (data.ranged_attack_release_time !== undefined) {
      ...
      for (let i = 0; i < data.length; i++) {
        ...
        switch (i + 1) {
          ...
          case 2:
            ...
            break;
          case 3:
            fields.ranged_attack_projectile_visual_id =
              t.deserializeOptionalString(data[i]);
            break;
          case 4:
            fields.ranged_attack_cast_time = t.deserializeOptionalF64(data[i]);
            break;
          case 5:
            fields.ranged_attack_aim_point = t.deserializeOptionalVec3f(
              data[i]
            ...
            break;
          case 6:
            fields.ranged_attack_result = t.deserializeOptionalString(data[i]);
            break;
          case 7:
            fields.ranged_attack_charge_time_secs = t.deserializeOptionalF64(
              data[i]
  ...
  static deserialize(data: any): c.MovementState {
    ...
    if (!Array.isArray(data)) {
      ...
      if (data[5] !== undefined) {
        ...
        fields.invulnerability_expiry_time = t.deserializeF64(
          data.invulnerability_expiry_time
        );
      }
      if (data[6] !== undefined) {
        fields.cooldown_expiry_time = t.deserializeF64(data[6]);
      } else if (data.cooldown_expiry_time !== undefined) {
        fields.cooldown_expiry_time = t.deserializeF64(
          data.cooldown_expiry_time
        );
      }
      if (data[7] !== undefined) {
  ...
  static serialize(
    ...
    if (entity.movement_state !== undefined) {
      if (entity.movement_state === null) {
        ...
        data.push(157, MovementStateSerde.serialize(entity.movement_state));
      }
    }
    return data;
  }
    ...
    if (data.length === 0) {
      ...
      }
      {
        ...
        if (value === null && decodeDelta) {
          ...
          entity.movement_state = MovementStateSerde.deserialize(
            legacyEntity.movement_state
          );
        }
      }
  ...
  static serialize(event?: ev.Event) {
    switch (event?.kind) {
      ...
      case "movementActionEvent":
        return MovementActionEventSerde.serialize(
          event as ev.MovementActionEvent
        );
