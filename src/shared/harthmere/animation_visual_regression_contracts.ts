// Harthmere animation visual regression contracts
...
export const HARTHMERE_WEAPON_HAND_TRACKING_CONTRACT = {
...
export const HARTHMERE_CREATURE_ANIMAL_ANIMATION_CONTRACT = {
  version: HARTHMERE_CREATURE_SOCIAL_DEATH_HANDTRACKING_VERSION,
...
export const HARTHMERE_SOCIAL_WORK_NPC_ANIMATION_CONTRACT = {
  version: HARTHMERE_CREATURE_SOCIAL_DEATH_HANDTRACKING_VERSION,
  states: [
    "vendorIdle",
    "talkGesture",
...
export const HARTHMERE_DEATH_RESPAWN_CINEMATIC_CONTRACT = {
  version: HARTHMERE_CREATURE_SOCIAL_DEATH_HANDTRACKING_VERSION,
