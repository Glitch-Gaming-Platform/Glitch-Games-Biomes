...
export const HARTHMERE_BUSINESS_SCENARIO_MODIFIERS: readonly HarthmereBusinessScenarioModifier[] =
  [
    ...
    },
    {
      ...
      mood: "weary",
      linePrefix: "Just got off a long shift. ",
      lineSuffix: "",
      patienceMultiplier: 1.1,
      difficultyDelta: 0,
      rewardMultiplier: 1.05,
    ...
    },
    {
      ...
      mood: "exacting",
      linePrefix: "",
      lineSuffix: " I will check every detail.",
      patienceMultiplier: 0.85,
      difficultyDelta: 2,
      rewardMultiplier: 1.3,
      reputationDelta: 1,
    },
    {
      ...
      mood: "calculating",
      linePrefix: "I'm comparing a few places. ",
      lineSuffix: "",
      patienceMultiplier: 0.95,
      difficultyDelta: 1,
    ...
    },
    {
      id: "grateful_regular",
      mood: "appreciative",
      linePrefix: "You've never let me down. ",
      lineSuffix: "",
      patienceMultiplier: 1.25,
      difficultyDelta: 0,
      rewardMultiplier: 1.15,
    ...
    },
    {
      id: "deadline_crunch",
      mood: "frantic",
      linePrefix: "My deadline is in minutes. ",
      lineSuffix: " No time to redo it.",
      patienceMultiplier: 0.55,
      difficultyDelta: 2,
      rewardMultiplier: 1.4,
      reputationDelta: 1,
    },
    {
      id: "curious_tourist",
      mood: "wide_eyed",
      linePrefix: "Just passing through Harthmere. ",
      lineSuffix: "",
    ...
    },
    {
      id: "stubborn_diy",
      mood: "reluctant",
      linePrefix: "I tried fixing it myself first. ",
      lineSuffix: "",
      patienceMultiplier: 1,
      difficultyDelta: 2,
      rewardMultiplier: 1.1,
    ...
    },
    {
      ...
      mood: "influential",
      linePrefix: "",
      lineSuffix: " People will hear how this goes.",
      patienceMultiplier: 0.9,
      difficultyDelta: 1,
      rewardMultiplier: 1.25,
      reputationDelta: 2,
    },
    {
      id: "soft_spoken",
      mood: "gentle",
      linePrefix: "Whenever you have a moment... ",
      lineSuffix: "",
      patienceMultiplier: 1.3,
      difficultyDelta: 0,
      rewardMultiplier: 1,
    ...
    },
    {
      id: "budget_committee",
      mood: "scrutinizing",
      linePrefix: "I have to justify every coin spent. ",
      lineSuffix: "",
      patienceMultiplier: 1.05,
      difficultyDelta: 1,
    ...
    },
    {
      id: "last_minute_gift",
      mood: "sheepish",
      linePrefix: "It's a gift and I forgot until now. ",
      lineSuffix: "",
      patienceMultiplier: 0.7,
      difficultyDelta: 1,
      rewardMultiplier: 1.3,
    ...
    },
    {
      ...
      mood: "jaded",
      linePrefix: "",
      lineSuffix: " Don't bother with the sales pitch.",
      patienceMultiplier: 0.9,
      difficultyDelta: 1,
      rewardMultiplier: 1,
      reputationDelta: 0,
    },
    {
      id: "eager_apprentice",
      mood: "enthusiastic",
      linePrefix: "I want to learn how this works too. ",
      lineSuffix: "",
    ...
    },
    {
      id: "storm_warning",
      mood: "hurried",
      linePrefix: "A storm is rolling in. ",
      lineSuffix: " I need to beat the weather.",
    ...
    },
    {
      ...
      mood: "observant",
      linePrefix: "",
      lineSuffix: " I'm noting how each shop handles this.",
      patienceMultiplier: 0.95,
      difficultyDelta: 2,
      rewardMultiplier: 1.2,
      reputationDelta: 2,
...
const HARTHMERE_BUSINESS_REQUEST_CONTEXTS: readonly {
  ...
  { id: "dawn_start", line: "I want it sorted before the day starts." },
  { id: "shift_change", line: "My shift changes at the next bell." },
  { id: "caravan_leaving", line: "The caravan leaves at sundown." },
  { id: "rent_due", line: "Rent is due and this can't slip." },
  { id: "boss_watching", line: "My boss is asking for updates hourly." },
  { id: "kids_at_home", line: "I have to get back to the kids soon." },
  { id: "supply_run", line: "It is part of a bigger supply run." },
  { id: "first_payday", line: "Just got paid, so today is the day." },
  { id: "council_review", line: "The council reviews my permit this week." },
  { id: "wedding_prep", line: "There's a wedding I'm preparing for." },
  { id: "harvest_window", line: "The harvest window closes fast." },
  { id: "ledger_close", line: "I close my ledger at week's end." },
  { id: "travel_soon", line: "I leave town tomorrow morning." },
  { id: "shared_cost", line: "Three of us are splitting the cost." },
  { id: "promised_someone", line: "I promised someone I'd handle it today." },
  { id: "early_riser", line: "I like to get errands done early." },
];
...
const HARTHMERE_BUSINESS_REQUEST_COMPLICATIONS: readonly {
  ...
  { id: "split_payment", line: "Can the cost be split into parts?" },
  { id: "language_barrier", line: "Bear with me, the terms confuse me." },
  { id: "tight_fit", line: "Space is tight where this has to go." },
  { id: "previous_owner", line: "The previous owner left it in rough shape." },
  { id: "seasonal_demand", line: "Everyone wants this right now, I know." },
  { id: "documentation_needed", line: "I need it logged for an audit later." },
  { id: "match_existing", line: "It has to match what I already own." },
