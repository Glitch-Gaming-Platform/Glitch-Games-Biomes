...
export const HARTHMERE_JOBS_BOARD_BUSINESS_TEMPLATES: HarthmereJobsBoardBusinessTemplate[] =
  [
      ...
      requirements: [
        {
          ...
          targetName: "Refinery Intake Terminal",
    ...
    },
    {
      ...
      description:
        "Bring repair parts and equip a repair tool at the marked anchor leak, then confirm the habitat is safe before returning to the board.",
      kind: "repair",
      requirements: [
        {
          itemId: "repair_part",
          ...
          targetName: "Biome Anchor Leak Pillar",
      ...
      requirements: [
        {
          ...
          targetName: "Trade Route Watch Post",
    ...
    },
    {
      ...
      description:
        "Carry sealed portal fuel to the gate office before the route destabilizes.",
      kind: "delivery",
      requirements: [
        {
          itemId: "portal_fuel",
          ...
          targetName: "Portal Gate Office Terminal",
      ...
      requirements: [
        {
          ...
          targetName: "Old Route Marker Stone",
      ...
      requirements: [
        {
          ...
          targetName: "Hunter Larder Shelf",
    ...
    },
    {
      ...
      description:
        "Bring repair parts and equip a repair tool at the marked fixture, then verify it is usable again.",
      kind: "repair",
      requirements: [
        {
          itemId: "repair_part",
          ...
          targetName: "Broken Market Fixture Stand",
      ...
      requirements: [
        {
          ...
          targetName: "Restaurant Kitchen Prep Table",
      ...
      requirements: [
        {
          ...
          targetName: "Clinic Delivery Lockbox",
