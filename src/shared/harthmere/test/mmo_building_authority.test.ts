/**
 * mmo_building_authority.test.ts
 *
...
import {
  ...
  validateHarthmereBuildingDemolition,
  validateHarthmerePlotClaim,
  type HarthmereBuildingPlacementRequest,
  type HarthmereBuildingPlacementContext,
  type HarthmereBuildingDemolitionRequest,
  type HarthmereBuildingDemolitionContext,
  type HarthmerePlotClaimRequest,
  type HarthmerePlotClaimContext,
  type HarthmereStructureDefinition,
...
): HarthmereBuildingPlacementContext["terrainColumns"] {
...
function makeResidentialPlot(
  overrides: Partial<HarthmerePlotDefinition> = {}
...
function makeValidPlacementCtx(
  overrides: Partial<HarthmereBuildingPlacementContext> = {}
...
function makePlacementReq(
  overrides: Partial<HarthmereBuildingPlacementRequest> = {}
): HarthmereBuildingPlacementRequest {
  return {
    requestId: nextReqId(),
    actorId: "player_1",
...
before(function registerTestStructures() {
  ...
  registerHarthmereStructureDefinition(roadStall);
});

// ===========================================================================
// 1. validateHarthmereBuildingPlacement — success cases
// ===========================================================================

describe("validateHarthmereBuildingPlacement — success", function () {
...
describe("validateHarthmereBuildingPlacement — unknown structure type", function () {
...
describe("validateHarthmereBuildingPlacement — unbuildable terrain", function () {
  const unbuildableTypes: HarthmereTerrainType[] = [
    "water",
    "lava",
    "road",
    "bridge",
...
describe("validateHarthmereBuildingPlacement — slope violations", function () {
...
describe("validateHarthmereBuildingPlacement — foundation support", function () {
...
describe("validateHarthmereBuildingPlacement — plot boundary", function () {
...
describe("validateHarthmereBuildingPlacement — clipping", function () {
...
describe("validateHarthmereBuildingPlacement — NPC route clearance", function () {
...
describe("validateHarthmereBuildingPlacement — quest trigger areas", function () {
...
describe("validateHarthmereBuildingPlacement — entrance clearance", function () {
...
describe("validateHarthmereBuildingPlacement — road access", function () {
...
describe("validateHarthmereBuildingPlacement — multiple violations", function () {
...
describe("validateHarthmereBuildingPlacement — rotation footprint", function () {
...
// ===========================================================================
// 14. validateHarthmereBuildingDemolition
// ===========================================================================

describe("validateHarthmereBuildingDemolition", function () {
  function makeDemolitionReq(
    overrides: Partial<HarthmereBuildingDemolitionRequest> = {}
  ): HarthmereBuildingDemolitionRequest {
    return {
      requestId: nextReqId(),
      actorId: "player_1",
  ...
  it("allows demolition when actor is structure owner", function () {
    const result = validateHarthmereBuildingDemolition(makeDemolitionReq(), {
...
// ===========================================================================
// 15. validateHarthmerePlotClaim
// ===========================================================================

describe("validateHarthmerePlotClaim", function () {
  function makePlotClaimReq(
    overrides: Partial<HarthmerePlotClaimRequest> = {}
  ): HarthmerePlotClaimRequest {
    return {
      requestId: nextReqId(),
      actorId: "player_1",
      plotId: "plot_res_99",
  ...
  function makePlotClaimCtx(
    overrides: Partial<HarthmerePlotClaimContext> = {}
  ): HarthmerePlotClaimContext {
    return {
