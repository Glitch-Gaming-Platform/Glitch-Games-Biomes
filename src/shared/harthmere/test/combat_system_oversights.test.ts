...
import {
  ...
  type HarthmereCombatAbility,
  type HarthmereCombatRequest,
  type HarthmereCombatStats,
  type HarthmereRespawnPoint,
} from "../combat_system";
...
describe("combat_system rule oversight fixes", () => {
...
describe("combat_system — friendly fire + support abilities (audit hardening)", () => {
