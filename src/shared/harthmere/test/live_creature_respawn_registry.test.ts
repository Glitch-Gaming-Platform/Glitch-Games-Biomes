...
import { HarthmereLiveCreatureRespawnRegistry } from "@/shared/harthmere/live_creature_respawn_registry";
import { HARTHMERE_LIVE_CREATURE_RESPAWN_MIN_MS } from "@/shared/harthmere/live_creature_render";
import assert from "assert";

describe("HarthmereLiveCreatureRespawnRegistry", () => {
  it("suppresses a killed creature until its respawn time", () => {
    ...
    assert.equal(respawnAt, now + HARTHMERE_LIVE_CREATURE_RESPAWN_MIN_MS);
