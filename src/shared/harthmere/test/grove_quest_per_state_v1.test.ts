...
//
// This file is data-driven over SNAPSHOT_GROVE_QUESTS_V75 so adding a
...
export const GROVE_QUEST_PER_STATE_TEST_VERSION_V1 =
  "grove-quest-per-state-test-v1" as const;
...
function acceptGroveQuest(state: GroveSimState, quest: SnapshotGroveQuestV75) {
...
function driveQuestThroughEveryState(quest: SnapshotGroveQuestV75) {
...
export function buildGroveQuestPerStateCatalogReport(): GroveQuestPerStateCatalogReport {
  ...
  return {
    totalQuests: SNAPSHOT_GROVE_QUESTS_V75.length,
    failingQuests,
    reports,
  };
}
...
if (
  ...
  (describe as any)("Grove quest per-state contract v1", () => {
