...
before(function registerNonNpcLiveEntityCombatFixtures() {
  const rawMeat: HarthmereItemDefinitionV1 = {
    itemId: "raw_meat",
  ...
  const hideScrap: HarthmereItemDefinitionV1 = {
  ...
  registerHarthmereItemDefinitionV1(rawMeat);
  registerHarthmereItemDefinitionV1(hideScrap);

  const playerBodyAttack: HarthmereAbilityCatalogueEntryV1 = {
  ...
  const nonNpcBodyAttack: HarthmereAbilityCatalogueEntryV1 = {
  ...
  registerHarthmereAbilityV1(playerBodyAttack);
  registerHarthmereAbilityV1(nonNpcBodyAttack);
  registerHarthmereClassDefinitionV1(warrior);
});

describe("non-NPC b:<id> live entity combat bridge v1", () => {
