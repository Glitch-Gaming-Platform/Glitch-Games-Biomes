...
import {
  createHarthmereLiveEntityCombatSnapshotFromEcsRecord,
  createHarthmereLiveEntityCombatSnapshotsFromEcsRecords,
} from "../live_entity_ecs_bridge";

describe("live entity ECS bridge current", () => {
  ...
  it("keeps protected species and friendly humans as noncombatants while livestock and owned pets stay attackable", () => {
    const livestock = createHarthmereLiveEntityCombatSnapshotFromEcsRecord(
      "b:livestock",
      {
    ...
    const ownedPet = createHarthmereLiveEntityCombatSnapshotFromEcsRecord(
      "b:pet",
      {
  ...
  it("skips records with no usable world position", () => {
    assert.equal(
      createHarthmereLiveEntityCombatSnapshotFromEcsRecord("b:missing", {
