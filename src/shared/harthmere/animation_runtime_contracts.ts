...
export const HARTHMERE_FULL_ANIMATION_RUNTIME_VERSION =
  "harthmere-full-animation-runtime";

export type HarthmereAnimationFamily =
  | "creature" | "mount" | "ranged" | "magic" | "shield" | "dodge"
  | "airborne" | "gathering" | "crafting" | "building" | "social"
  | "deathRespawn" | "boss" | "screenshot";

export type HarthmereAnimationRequest = {
  family: HarthmereAnimationFamily;
  action: string;
...
export const HARTHMERE_ANIMATION_FAMILY_ORDER: readonly HarthmereAnimationFamily[] = [
  "creature", "mount", "ranged", "magic", "shield", "dodge", "airborne",
  "gathering", "crafting", "building", "social", "deathRespawn", "boss", "screenshot",
] as const;

export const HARTHMERE_FULL_ANIMATION_CLIP_FAMILIES = {
  creature: {
...
export const HARTHMERE_SCREENSHOT_BASELINES = [
...
export function harthmereAnimationTimingForFamily(family: HarthmereAnimationFamily) {
  const profile = HARTHMERE_FULL_ANIMATION_CLIP_FAMILIES[family] as {
