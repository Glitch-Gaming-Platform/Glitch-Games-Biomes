// Auto-generated by install-harthmere-quest-tests.sh.
// Harthmere quest catalog and validation contract.

export const HARTHMERE_QUEST_CATALOG_VERSION = 46 as const;
...
export interface HarthmereQuestContext {
  playerLevel: number;
  hour: number;
...
export interface HarthmereQuestValidationResult {
  ok: boolean;
  reasons: string[];
}

export const HARTHMERE_QUEST_COVERAGE_POLICY_JSON = `{
  "version": 46,
...
export const HARTHMERE_QUEST_CATALOG_JSON = `[
  {
...
export const HARTHMERE_QUEST_COVERAGE_POLICY = JSON.parse(
  HARTHMERE_QUEST_COVERAGE_POLICY_JSON,
) as {
  version: 46;
...
export const HARTHMERE_QUEST_CATALOG = JSON.parse(
  HARTHMERE_QUEST_CATALOG_JSON,
) as readonly any[];

export function getHarthmereQuestById(id: string) {
  return HARTHMERE_QUEST_CATALOG.find((quest) => quest.id === id);
}

export function validateHarthmereQuestActivation(
  quest: any,
  context: HarthmereQuestContext,
): HarthmereQuestValidationResult {
...
export function getActiveHarthmereQuests(context: HarthmereQuestContext) {
  return HARTHMERE_QUEST_CATALOG.filter((quest) =>
    validateHarthmereQuestActivation(quest, context).ok,
  );
}

export function previewHarthmereQuestRewards(questId: string) {
...
export function validateHarthmereQuestCatalog() {
