...
export const HARTHMERE_PRODUCTION_POLISH_RENDER_BUDGETS = {
  ...
  nearLodDistanceMeters: 36,
  interiorLodDistanceMeters: 16,
  tinyLodDistanceMeters: 8,
  eventLodDistanceMeters: 48,
...
export const HARTHMERE_RUNTIME_PERFORMANCE_PROFILE = {
  ...
  farRadiusMeters: 285,
  maxRuntimePlacementsOptimized: 220,
  maxAnimatedLifeOptimized: 24,
  maxTinyPropsOptimized: 16,
  maxWildsActorsOptimized: 8,
  maxWildsRuntimePlacementsOptimized: 24,
  maxUnsupportedFloatingBlocksVisible: 0,
  optimizedTerrainShardBudget: 288,
} as const;
