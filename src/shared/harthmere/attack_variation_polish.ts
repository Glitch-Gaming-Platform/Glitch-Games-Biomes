...
export function advanceHarthmereAttackVariationIndex(
  ...
  const nextIndex = (__harthmereVariationCycleState[family] + 1) % variants.length;
...
export function getHarthmereAttackFamilyForAction(actionType: string): HarthmereAttackFamily {
