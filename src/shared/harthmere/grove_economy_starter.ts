...
// grove_townsfolk_appearance.ts) so the same patch that gives them quests
...
//
// The quest data conforms to SnapshotGroveQuest and the trigger contract
// in snapshot_grove_trigger_contract.ts. Each quest's objectives,
// triggers, and markerIds arrays are parallel and length-aligned so the
// grove_quest_per_state test suite covers them automatically.

import type {
  SnapshotGroveLandmark,
  SnapshotGroveNpc,
  SnapshotGroveQuest,
...
// snapshot_grove_content imports this file to append the economy cast, so
...
export const GROVE_ECONOMY_AUTHORED_NPC_FEET_Y = 53;
export const GROVE_ECONOMY_STARTER_NPC_FEET_Y =
  GROVE_ECONOMY_AUTHORED_NPC_FEET_Y;
...
function groveEconomyFountainPosition(dx: number, dz: number): Vec3 {
  return [
    ...
    GROVE_ECONOMY_STARTER_FOUNTAIN_CENTER_Z + dz,
  ];
}
...
// manifest in grove_townsfolk_appearance.ts can render them with unique
...
export interface GroveTownsfolkProceduralSpec {
...
export interface GroveTownsfolkNpc
  extends Omit<SnapshotGroveNpc, "snapshotAsset"> {
  proceduralAppearanceSpec: GroveTownsfolkProceduralSpec;
}

const FEET_Y = GROVE_ECONOMY_STARTER_NPC_FEET_Y;

export const GROVE_ECONOMY_STARTER_NPCS: GroveTownsfolkNpc[] = [
  {
    id: "gus_the_baker",
    ...
    authoredPosition: groveEconomyStarterFountainPosition(-10, 0),
    orientation: [0, 1.6],
    shortDescription:
  ...
  },
  {
    ...
    authoredPosition: groveEconomyStarterFountainPosition(0, 8),
    orientation: [0, 3.1],
    shortDescription:
  ...
  },
  {
    ...
    authoredPosition: groveEconomyStarterFountainPosition(8, 8),
    orientation: [0, 4.0],
    shortDescription:
  ...
  },
  {
    ...
    authoredPosition: groveEconomyStarterFountainPosition(2, -7),
    orientation: [0, 0.3],
    shortDescription:
...
export const GROVE_ECONOMY_STARTER_LANDMARKS: SnapshotGroveLandmark[] = [
  ...
  },
  {
    ...
    label: "Gus's Oven",
    position: [
      groveEconomyStarterFountainPosition(-10, 1)[0],
      groveEconomyStarterFountainPosition(-10, 1)[1] + 1,
      groveEconomyStarterFountainPosition(-10, 1)[2],
    ],
    kind: "interactable",
    area: "the_grove",
    visibleOnWorldMap: true,
  },
  {
    ...
    position: [
      groveEconomyStarterFountainPosition(1, 9)[0],
      groveEconomyStarterFountainPosition(1, 9)[1] + 1,
      groveEconomyStarterFountainPosition(1, 9)[2],
    ],
    kind: "interactable",
    area: "the_grove",
    visibleOnWorldMap: true,
  },
  {
    ...
    label: "Berry Patch",
    position: [
      groveEconomyStarterFountainPosition(3, 10)[0],
      groveEconomyStarterFountainPosition(3, 10)[1] + 1,
      groveEconomyStarterFountainPosition(3, 10)[2],
    ],
    kind: "resource",
    area: "the_grove",
    visibleOnWorldMap: true,
  ...
  // HARTHMERE_WORLD_OBJECT_PROP_COVERAGE:
...
export const GROVE_ECONOMY_STARTER_QUESTS: SnapshotGroveQuest[] = [
  // ---- Billy (3 quests) ---------------------------------------------------
  {
...
export function totalEconomyStarterBling(): number {
  return GROVE_ECONOMY_STARTER_QUESTS.reduce((total, quest) => {
