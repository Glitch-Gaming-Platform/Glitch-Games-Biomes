// Harthmere animation handedness/death/bounds contracts current.
...
export const HARTHMERE_ANIMATION_HANDEDNESS_DEATH_BOUNDS_VERSION =
  "harthmere-animation-handedness-death-bounds" as const;

export const HARTHMERE_MAIN_HAND_VISUAL_CONTRACT = {
...
export const HARTHMERE_DEATH_ALL_ACTOR_CONTRACT = {
  version: HARTHMERE_ANIMATION_HANDEDNESS_DEATH_BOUNDS_VERSION,
  actorFamilies: [
    "player",
    "remote_player",
...
export const HARTHMERE_DEATH_BOUNDS_SPACING_CONTRACT = {
  version: HARTHMERE_ANIMATION_HANDEDNESS_DEATH_BOUNDS_VERSION,
  tests: [
...
export const HARTHMERE_WORLD_EFFECT_RANGE_VISIBILITY_CONTRACT = {
  version: HARTHMERE_ANIMATION_HANDEDNESS_DEATH_BOUNDS_VERSION,
