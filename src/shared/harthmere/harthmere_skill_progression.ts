...
> = {
  character_level: ["Defeat native ECS creatures", "Complete native quests"],
  combat: ["Land a native ECS combat hit"],
  melee_combat: ["Land an unarmed, melee, or heavy native ECS hit"],
  ranged_combat: ["Land a native ECS ranged hit"],
  shield_mastery: ["Take a validated combat hit while a shield is equipped"],
  dagger_mastery: ["Land a native ECS hit with a dagger or knife"],
  lockpicking: ["Open a validated world door or gate"],
  archery: ["Land a native ECS hit with a bow or crossbow"],
  tracking: ["Defeat or inspect wildlife and complete hunting interactions"],
  fire_magic: ["Land a native ECS fire or generic spell hit"],
  arcane_literacy: ["Read runes, inspect magical objects, or enchant an item"],
  holy_magic: ["Use holy items, healing rites, or holy spell attacks"],
  medicine: ["Use a medical item or complete doctor treatment"],
  death_lore: ["Inspect graves or use death-aligned magic"],
  shadow_magic: ["Study death objects or use shadow-aligned magic"],
  nature_magic: ["Tend native crops or study living-world objects"],
  farming: ["Till, plant, water, fertilize, or harvest native Gaia crops"],
  mining: ["Break natural ore or stone and mine authored resource nodes"],
  gathering: ["Harvest natural blocks, fish, forage, or use resource nodes"],
  cooking: ["Cook or collect a completed cooking job"],
  crafting: ["Complete a native or Harthmere craft"],
  blacksmithing: ["Complete a blacksmithing recipe"],
  leatherworking: ["Complete a leatherworking recipe"],
  carpentry: ["Complete a carpentry recipe or repair a world object"],
  tailoring: ["Complete a tailoring recipe"],
  alchemy: ["Complete an alchemy recipe"],
  enchanting: ["Complete an enchanting recipe"],
  exotic_refining: ["Complete an exotic-refining recipe"],
  bell_forging: ["Complete a bell-forging recipe"],
  fishing: ["Catch a fish or use an authored fishing pool"],
  care: ["Complete daily care or tend a world object"],
  persuasion: ["Talk to an NPC or complete a negotiation action"],
  performance: ["Use a validated practice or performance object"],
  business_operations: [
    "Complete a business, market, staffing, or contract action",
  ],
};
