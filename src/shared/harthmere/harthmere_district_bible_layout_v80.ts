// HARTHMERE_DISTRICT_BIBLE_LAYOUT_V80
//
...
//   - snapshot_grove_harthmere_lore_bible_v1.pdf
...
//     HARTHMERE_CONNECTED_MAP_PRESENTATION_V66) and shares the same ground Y
...
//     districts go; the terrain seeding/shifting (e.g. town_block_build_v1
...
// HARTHMERE_CONNECTED_MAP_ROUTE_ANCHORS_V66.  This means: every coordinate
...
export const HARTHMERE_DISTRICT_BIBLE_LAYOUT_VERSION_V80 =
  "harthmere-district-bible-layout-v80" as const;
 ...
 * by the layout tests.
 */
export const HARTHMERE_LAYOUT_GROUND_Y_V80 = SNAPSHOT_GROVE_WORLD_GROUND_Y_V75;
export const HARTHMERE_LAYOUT_FEET_Y_V80 = SNAPSHOT_GROVE_NPC_FEET_Y_V75;
export const HARTHMERE_LAYOUT_MARKER_Y_V80 =
  SNAPSHOT_GROVE_WORLD_GROUND_Y_V75 + 2;
 ...
 */
export type HarthmereBibleDistrictIdV80 =
  | "north_gate"
  | "market_square"
  | "player_services"
  | "copper_kettle"
...
export interface HarthmereBibleDistrictV80 {
  id: HarthmereBibleDistrictIdV80;
  label: string;
  ...
  // (Their homes may be elsewhere — see HARTHMERE_BIBLE_NPC_RESIDENCES_V80.)
...
export interface HarthmereBibleResidenceV80 {
  ...
  districtId: HarthmereBibleDistrictIdV80;
 ...
 *
 * These match SNAPSHOT_HARTHMERE_LIVE_BOUNDS_V78 (snapshot_live_debug_v78.ts)
 * — they MUST match, and the tests enforce equality.
 */
export const HARTHMERE_TOWN_LAYOUT_BOUNDS_V80 = {
  minX: 192,
  maxX: 768,
  minZ: -512,
  maxZ: 192,
  groundY: HARTHMERE_LAYOUT_GROUND_Y_V80,
} as const;
 ...
 */
export const HARTHMERE_BIBLE_DISTRICTS_V80: ReadonlyArray<HarthmereBibleDistrictV80> = [
  {
    id: "north_gate",
    label: "North Gate",
    bibleSection: "7.1 North Gate",
    bounds: { minX: 460, maxX: 500, minZ: -300, maxZ: -270 },
    anchor: [500, HARTHMERE_LAYOUT_MARKER_Y_V80, -270],
    primaryRole: "gate",
    ...
    landmarks: [
      {
        ...
        label: "North Gate",
        position: [500, HARTHMERE_LAYOUT_MARKER_Y_V80, -284],
        icon: "gate",
      },
      {
        id: "harthmere_toll_desk",
        label: "Toll Desk",
        position: [488, HARTHMERE_LAYOUT_MARKER_Y_V80, -276],
      },
      {
        id: "harthmere_caravan_queue",
        label: "Caravan Queue",
        position: [512, HARTHMERE_LAYOUT_MARKER_Y_V80, -292],
      },
    ],
  },
  {
    ...
    anchor: [510, HARTHMERE_LAYOUT_MARKER_Y_V80, -252],
    primaryRole: "gate",
    ...
    landmarks: [
      {
        ...
        position: [512, HARTHMERE_LAYOUT_MARKER_Y_V80, -252],
      },
    ],
  },
  {
    ...
    anchor: [570, HARTHMERE_LAYOUT_MARKER_Y_V80, -250],
    ...
    landmarks: [
      {
        ...
        label: "Reeve's Hall",
        position: [566, HARTHMERE_LAYOUT_MARKER_Y_V80, -250],
        icon: "council",
      },
      {
        id: "harthmere_noble_gardens",
        label: "Noble Gardens",
        position: [582, HARTHMERE_LAYOUT_MARKER_Y_V80, -242],
      },
    ],
  },
  {
    ...
    anchor: [490, HARTHMERE_LAYOUT_MARKER_Y_V80, -210],
    primaryRole: "market",
    ...
    landmarks: [
      {
        ...
        position: [490, HARTHMERE_LAYOUT_MARKER_Y_V80, -210],
        icon: "fountain",
      },
      {
        id: "harthmere_market_posting_board",
        label: "Posting Board",
        position: [482, HARTHMERE_LAYOUT_MARKER_Y_V80, -198],
        icon: "board",
      },
      {
        id: "harthmere_auction_house",
        label: "Auction House",
        position: [518, HARTHMERE_LAYOUT_MARKER_Y_V80, -202],
        icon: "auction",
      },
    ],
  },
  {
    ...
    anchor: [560, HARTHMERE_LAYOUT_MARKER_Y_V80, -200],
    ...
    landmarks: [
      {
        ...
        position: [560, HARTHMERE_LAYOUT_MARKER_Y_V80, -200],
        icon: "inn",
      },
      {
        id: "harthmere_mail_post",
        label: "Mail Post",
        position: [572, HARTHMERE_LAYOUT_MARKER_Y_V80, -208],
        icon: "mail",
      },
    ],
  },
  {
    ...
    anchor: [560, HARTHMERE_LAYOUT_MARKER_Y_V80, -228],
    primaryRole: "services",
    ...
    landmarks: [
      {
        ...
        label: "Vault Office",
        position: [552, HARTHMERE_LAYOUT_MARKER_Y_V80, -228],
        icon: "bank",
      },
      {
        id: "harthmere_storage_lockers",
        label: "Storage Lockers",
        position: [568, HARTHMERE_LAYOUT_MARKER_Y_V80, -232],
        icon: "storage",
      },
    ],
  },
  {
    ...
    anchor: [528, HARTHMERE_LAYOUT_MARKER_Y_V80, -240],
    ...
    landmarks: [
      {
        ...
        label: "Vale Forge",
        position: [528, HARTHMERE_LAYOUT_MARKER_Y_V80, -240],
        icon: "forge",
      },
      {
        id: "harthmere_carpenter_yard",
        label: "Carpenter Yard",
        position: [544, HARTHMERE_LAYOUT_MARKER_Y_V80, -244],
      },
      {
        id: "harthmere_tannery",
        label: "Tannery",
        position: [510, HARTHMERE_LAYOUT_MARKER_Y_V80, -252],
      },
    ],
  },
  {
    ...
    anchor: [470, HARTHMERE_LAYOUT_MARKER_Y_V80, -150],
    primaryRole: "faith",
    ...
    landmarks: [
      {
        ...
        position: [470, HARTHMERE_LAYOUT_MARKER_Y_V80, -150],
        icon: "chapel",
      },
      {
        id: "harthmere_memorial_garden",
        label: "Memorial Garden",
        position: [486, HARTHMERE_LAYOUT_MARKER_Y_V80, -140],
      },
    ],
  },
  {
    ...
    anchor: [610, HARTHMERE_LAYOUT_MARKER_Y_V80, -190],
    primaryRole: "docks",
    ...
    landmarks: [
      {
        ...
        position: [610, HARTHMERE_LAYOUT_MARKER_Y_V80, -190],
        icon: "dock",
      },
      {
        id: "harthmere_river_warehouse",
        label: "River Warehouse",
        position: [628, HARTHMERE_LAYOUT_MARKER_Y_V80, -198],
      },
      {
        id: "harthmere_river_pier",
        label: "River Pier",
        position: [646, HARTHMERE_LAYOUT_MARKER_Y_V80, -184],
      },
    ],
  },
  {
    ...
    anchor: [420, HARTHMERE_LAYOUT_MARKER_Y_V80, -150],
    ...
    landmarks: [
      {
        ...
        position: [420, HARTHMERE_LAYOUT_MARKER_Y_V80, -134],
      },
      {
        id: "harthmere_apothecary_fenlow",
        label: "Fenlow Apothecary",
        position: [440, HARTHMERE_LAYOUT_MARKER_Y_V80, -148],
        icon: "alchemy",
      },
    ],
  },
  {
    ...
    anchor: [510, HARTHMERE_LAYOUT_MARKER_Y_V80, -130],
    primaryRole: "mystery",
    ...
    landmarks: [
      {
        ...
        label: "Old Well",
        position: [490, HARTHMERE_LAYOUT_MARKER_Y_V80, -130],
        icon: "well",
      },
      {
        id: "harthmere_underways_grate",
        label: "Underways Grate",
        position: [504, HARTHMERE_LAYOUT_MARKER_Y_V80, -140],
      },
    ],
  },
  {
    ...
    anchor: [480, HARTHMERE_LAYOUT_MARKER_Y_V80, -340],
    primaryRole: "housing",
    ...
    landmarks: [
      {
        ...
        position: [410, HARTHMERE_LAYOUT_MARKER_Y_V80, -320],
      },
      {
        id: "harthmere_residential_well_south",
        label: "Residential Well (South)",
        position: [510, HARTHMERE_LAYOUT_MARKER_Y_V80, -360],
      },
    ],
  },
];
 ...
 * mirrors HARTHMERE_NAMED_NPCS_V44's `id`s; the layout tests will fail with
 * a clear diagnostic if a named NPC is added without a residence anchor.
 *
 * Bible refs for the canonical residences:
 *   - Bram Holt: "Guard barracks, room above the Guard Yard" (NPC compendium v44)
 ...
 */
export const HARTHMERE_BIBLE_NPC_RESIDENCES_V80: ReadonlyArray<HarthmereBibleResidenceV80> = [
  {
  ...
  },
  {
    ...
    doorstep: [414, HARTHMERE_LAYOUT_FEET_Y_V80, -158],
...
/** Lookup helpers. */
export function harthmereDistrictByIdV80(id: HarthmereBibleDistrictIdV80) {
  return HARTHMERE_BIBLE_DISTRICTS_V80.find((d) => d.id === id);
}

export function harthmereResidenceByNpcIdV80(npcId: string) {
  return HARTHMERE_BIBLE_NPC_RESIDENCES_V80.find((r) => r.npcId === npcId);
}

/** Returns the district whose bounds contain the given authored XZ. */
export function harthmereDistrictForPointV80(
  x: number,
  z: number,
): HarthmereBibleDistrictV80 | undefined {
  return HARTHMERE_BIBLE_DISTRICTS_V80.find(
    (d) =>
      x >= d.bounds.minX &&
      x <= d.bounds.maxX &&
      z >= d.bounds.minZ &&
 ...
 */
export function validateHarthmereLayoutV80() {
  const failures: string[] = [];

  // 1. Districts must not overlap.
  for (let i = 0; i < HARTHMERE_BIBLE_DISTRICTS_V80.length; i++) {
    for (let j = i + 1; j < HARTHMERE_BIBLE_DISTRICTS_V80.length; j++) {
      const a = HARTHMERE_BIBLE_DISTRICTS_V80[i];
      const b = HARTHMERE_BIBLE_DISTRICTS_V80[j];
  ...
  for (const d of HARTHMERE_BIBLE_DISTRICTS_V80) {
    if (
      d.bounds.minX < HARTHMERE_TOWN_LAYOUT_BOUNDS_V80.minX ||
      d.bounds.maxX > HARTHMERE_TOWN_LAYOUT_BOUNDS_V80.maxX ||
      d.bounds.minZ < HARTHMERE_TOWN_LAYOUT_BOUNDS_V80.minZ ||
      d.bounds.maxZ > HARTHMERE_TOWN_LAYOUT_BOUNDS_V80.maxZ
    ) {
  ...
  for (const r of HARTHMERE_BIBLE_NPC_RESIDENCES_V80) {
    const district = harthmereDistrictByIdV80(r.districtId);
    if (!district) {
