...
export const HARTHMERE_NPC_VISIBLE_GEOMETRY_GUARD_VERSION_V196 =
  "harthmere-npc-visible-geometry-guard-v196" as const;
...
export const HARTHMERE_NPC_MIN_RENDERABLE_VERTICES_V1 = 24;

export interface HarthmereNpcVisibleGeometryStatsV1 {
...
interface TraversableObject3DLikeV1 {
...
function materialIsVisibleV1(material: unknown): boolean {
  if (!material) {
...
export function harthmereNpcVisibleGeometryStatsForSceneV1(
  scene: TraversableObject3DLikeV1 | undefined | null
): HarthmereNpcVisibleGeometryStatsV1 {
  let visibleMeshes = 0;
  ...
  scene.traverse((object) => {
    ...
    const materials = Array.isArray(mesh.material)
      ? mesh.material
      : [mesh.material];
    if (!materials.some((material) => materialIsVisibleV1(material))) {
      return;
    }
    visibleMeshes += 1;
...
export function harthmereNpcSceneNeedsVisibleFallbackV1(
  scene: TraversableObject3DLikeV1 | undefined | null,
  minRenderableVertices: number = HARTHMERE_NPC_MIN_RENDERABLE_VERTICES_V1
): boolean {
