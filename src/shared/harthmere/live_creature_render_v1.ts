// HARTHMERE_LIVE_CREATURE_RENDER_V1
//
...
export type HarthmereLiveCreatureRenderFamilyV1 =
  | "mucker"
  | "hex"
  | "animal"
  | "robot"
...
export type HarthmereLiveCreatureRenderInputV1 = {
 ...
 */
export function harthmereLiveCreatureRenderFamilyV1(
  input: HarthmereLiveCreatureRenderInputV1
...
export const HARTHMERE_LIVE_CREATURE_RESPAWN_MIN_MS_V1 = 30 * 60 * 1000;
export const HARTHMERE_LIVE_CREATURE_RESPAWN_MAX_MS_V1 = 60 * 60 * 1000;
 ...
 */
export function harthmereLiveCreatureRespawnDelayMsV1(
  ...
  return Math.round(HARTHMERE_LIVE_CREATURE_RESPAWN_MIN_MS_V1 + r * span);
}

/**
 * Absolute respawn timestamp for a creature killed at `killedAtMs`.
 */
export function harthmereLiveCreatureRespawnAtV1(input: {
  killedAtMs: number;
  rng?: () => number;
}): number {
  return input.killedAtMs + harthmereLiveCreatureRespawnDelayMsV1(input.rng);
}
 ...
 */
export function harthmereLiveCreatureShouldRespawnV1(input: {
  nowMs: number;
  respawnAtMs: number;
}): boolean {
  return (
