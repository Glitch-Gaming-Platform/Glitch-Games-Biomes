// Generated by harthmere-body-weapon-aligned-clips.
// Production contract for body animations that visually sync with held weapons/items.

export const HARTHMERE_BODY_WEAPON_ANIMATION_SYNC_VERSION =
  "harthmere-body-weapon-aligned-clips-v2-ranged-stances";
export const HARTHMERE_BODY_WEAPON_ALIGNED_FRAME_COUNT = 30;
export const HARTHMERE_BODY_WEAPON_ALIGNED_FPS = 30;

export const HARTHMERE_BODY_VARIANT_TYPES = [
  "average",
  "slim",
  "broad",
  "stocky",
...
export const HARTHMERE_BODY_VARIANT_COLORS = [
  "earth",
  "forest",
  "river",
  "ember",
...
export const HARTHMERE_BODY_WEAPON_ALIGNED_CLIPS = [
...
export const HARTHMERE_BODY_WEAPON_PROFILE_CLIPS = {
  melee: {
  ...
  bow: {
    aim: "HarthmereBodyBowAim_Aligned_30",
    release: "HarthmereBodyBowRelease_Aligned_30",
  },
  gun: {
    aim: "HarthmereBodyGunAim_Aligned_30",
    fire: "HarthmereBodyGunFire_Aligned_30",
  },
  magic: {
...
export const HARTHMERE_GAMEPLAY_ITEM_BODY_PROFILE = {
...
export const HARTHMERE_BODY_WEAPON_SYNC_EDGE_CASES = [
  ...
  "bows and energy guns use distinct target-gated upper-body silhouettes",
