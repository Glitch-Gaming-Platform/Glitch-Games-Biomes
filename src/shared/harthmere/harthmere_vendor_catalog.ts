...
export const HARTHMERE_VENDOR_CATALOG: Record<number, HarthmereVendorProfile> =
  {
    ...
    29: vendor({
      ...
      stocks: [
        ...
        { itemId: "river_clay", quantity: 16, price: 3 },
        { itemId: "softwood_log", quantity: 24, price: 3 },
        { itemId: "oak_branch", quantity: 18, price: 2 },
        { itemId: "iron_ore", quantity: 14, price: 6 },
        { itemId: "scrap_metal", quantity: 16, price: 5 },
        { itemId: "tree_resin", quantity: 8, price: 8 },
        { itemId: "cloth_scrap", quantity: 20, price: 4 },
        { itemId: "clean_water", quantity: 12, price: 3 },
        { itemId: "old_coin", quantity: 8, price: 18 },
        { itemId: "mana_essence", quantity: 6, price: 24 },
      ],
      buys: [
        "weapon",
        "armor",
...
> = {
  ...
  arcane_extractor: {
    ...
    stats: { toolTier: 2 },
    description:
      "A glass-and-copper tool for drawing magical residue into vials.",
  },
  mana_essence: {
  ...
  rough_stone: {
    ...
    baseValue: 1,
    description:
      "Starter construction stone for foundations and road-safe pads.",
  },
  river_clay: {
    ...
    baseValue: 2,
    description:
      "Workable clay used for foundations, seals, and simple masonry.",
  },
  softwood_log: {
    ...
    maxStackSize: 200,
    baseValue: 2,
    description: "Straight softwood for framing, posts, and starter floors.",
  },
  oak_branch: {
  ...
  iron_ore: {
    ...
    maxStackSize: 200,
    baseValue: 4,
    description: "Unrefined ore for reinforced fixtures and building hardware.",
  },
  scrap_metal: {
    ...
    baseValue: 3,
    description:
      "Usable reclaimed metal for repairs, stalls, and reinforced trim.",
  },
  tree_resin: {
    ...
    baseValue: 6,
    description:
      "Sticky sealing resin for roofing, waterproofing, and joinery.",
  },
  cloth_scrap: {
    ...
    maxStackSize: 200,
    baseValue: 2,
    description: "Salvaged cloth for awnings, interiors, and workshop covers.",
  },
  clean_water: {
    ...
    baseValue: 2,
    description:
      "Clean construction water for clay work, cooking stations, and utility setup.",
  },
  old_coin: {
...
function vendorBuysStockCategory(
  ...
  const seedCategory =
    HARTHMERE_VENDOR_ITEM_DEFINITIONS[stock.itemId]?.category;
