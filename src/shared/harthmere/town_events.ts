// HARTHMERE_TOWN_EVENT_STATE_MUTATION
export const HARTHMERE_TOWN_EVENT_CATALOG = [
  "market day",
  "festival",
  "monster attack",
  "funeral",
...
export const HARTHMERE_TOWN_EVENT_MUTATIONS = [
  "NPC positions",
  "dialogue",
  "shop availability",
  "guard patrols",
...
export const HARTHMERE_TOWN_EVENT_SAFETY = {
...
export const HARTHMERE_PROCEDURAL_SOLID_ASSET_COLLISION =
