...
function shouldSeedLocalDevTerrain() {
  // Snapshot merge foundation: never seed the Harthmere/local-dev terrain into
  // the imported developer snapshot unless the caller explicitly forces it.
  // The shifted extra-town seed is introduced by the next patch, after the
  // coordinate offset has been applied.
  return (
