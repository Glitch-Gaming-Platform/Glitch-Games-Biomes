# Snapshot Grove Live NPC Bible v79

This is a snapshot-only expansion for **existing live snapshot NPC labels** that were visible in the Grove or already tracked by the live snapshot debug pass, but did not yet have full background stories in the Grove bible.

This document does **not** add new NPCs. It does **not** apply to Harthmere NPCs. Harthmere remains a separate connected town with its own bible and tone.

## Design rules

- Use this lore only for NPC labels already present in the snapshot/live Grove area.
- Do not spawn new ECS NPCs from this document.
- Do not apply this lore to Harthmere NPCs, Harthmere services, or Harthmere quest givers.
- NPC speech stays in character. Mission state, objective IDs, marker IDs, fallback text, and debug language stay in the HUD, journal, map, or developer tools.
- The Grove is the starter ecosystem: warm, readable, social, and quietly threatened by muck.

## Existing live snapshot NPCs expanded in v79
...
**Goal:** Keep watch over the Grove approach and call out early warnings when muck, lost travelers, or broken markers drift toward the starter road.

**Voice:** Quick, bright, a little smug from having seen everything first.

**Sample line:** “Road looks different from up here. Less brave, more honest.”
...
**Goal:** Keep the night path lit, repair dim lanterns, and make sure new players can still read signs when the sky goes dark.

**Voice:** Low, steady, practical, more reassuring than cheerful.

**Sample line:** “A lamp is not there to fight the dark. It is there so your feet do not have to guess.”
...
**Goal:** Mark which Mosslawn paths are safe enough for new travelers and which need Jane, Doc, or a Muck Buster.

**Voice:** Measured, patient, observant, with dry humor that arrives late but lands cleanly.

**Sample line:** “Fast feet miss soft ground. Soft ground remembers fast feet.”
...
**Goal:** Build a reliable Grove recovery ledger so Jackie, Jane, Luis, and Doc stop solving the same problems separately.

**Voice:** Organized, crisp, quietly kind, impossible to distract from a list.

**Sample line:** “If it grew, broke, vanished, or came back sticky, I have a page for it.”

### Patsy

**Home Area:** Genesis Crossroads  
...
**Goal:** Repair the Crossroads notice system so Road Ahead directions, bag recovery hints, and repair tasks do not blur together.

**Voice:** Soft, precise, nervous at first, then surprisingly firm about wording.

**Sample line:** “A label is a promise that someone thought of you before you got confused.”

### Gizela

**Home Area:** Shutter Cove  
...
**Goal:** Sort the cove's recovered objects and help Dimmi prove which reflections are real clues, not tricks of light.

**Voice:** Wry, superstitious but practical, always turning an object over in her hands.

**Sample line:** “The water gives things back when it wants someone to feel guilty.”
...
**Goal:** Keep the lower Grove path clear of small hazards and teach new travelers to look down as often as they look ahead.

**Voice:** Blunt, earnest, tiny but not timid.

**Sample line:** “Big people miss small problems. Then the small problems become rude.”

### Alva

**Home Area:** Old Grove Road  
...
**Goal:** Collect traveler hesitation points so the Road Ahead can be made clearer without making it feel like a lecture.

**Voice:** Quiet, generous, observant, asks better questions than most people answer.

**Sample line:** “The road tells on itself when people stop talking.”
...
**Goal:** Keep road repair supplies sorted so player repair steps can use real parts instead of vague tutorial magic.

**Voice:** Fast, practical, lightly exasperated, fond of exact counts.

**Sample line:** “If you need one bolt, bring three. The road eats small numbers.”
...
**Goal:** Make the sprint-jump tutorial feel like part of the road, not a disconnected movement drill.

**Voice:** Energetic, teasing, athletic, encouraging without being soft.

**Sample line:** “The road will not wait for perfect form. Practice anyway.”
...
**Goal:** Make sure starter tools, bags, and repair supplies are safe enough for new travelers to trust.

**Voice:** Gruff, practical, not unkind, allergic to waste.

**Sample line:** “New is fine. Tested is better. Found in a ditch is a maybe.”

### Emily

**Home Area:** Lovely Locks  
...
**Goal:** Keep the Grove's first-photo spots clear, pretty, and emotionally safe for new players finding their identity.

**Voice:** Warm, gentle, socially perceptive, quietly protective.

**Sample line:** “A welcome should have somewhere to stand, somewhere to breathe, and preferably flowers.”
