# Harthmere Combat Implementation Review
...
## Shared Combat Rules Layer

`src/shared/harthmere/combat_system.ts` is the pure combat rules engine for Harthmere. It is independent of React and localStorage, and is designed to be the source-of-truth rules contract for future server implementation and runtime wiring.
...
- `scripts/harthmere/test-harthmere-combat-system-core.cjs`
- `scripts/harthmere/test-harthmere-combat-system-integration.cjs`
