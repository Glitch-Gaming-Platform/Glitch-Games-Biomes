# Harthmere Living Quarters and Performance Fix

This document covers the console-log trouble spots where two-story residential/service buildings were incomplete and the renderer was dropping to roughly 1-2 FPS near living-quarter clusters.

## Fixes

- Replaces dense residential/slum shells with larger solid stone/ore wall panels.
...
```bash
node scripts/harthmere/test-harthmere-living-quarters-performance.cjs /Users/devindixon/Development/biomes-game
```
